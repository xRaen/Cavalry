...
static struct FScriptStruct_FMODStudio_StaticRegisterNativesFFMODLocalizedBankTable
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("FMODLocalizedBankTable")),new UScriptStruct::TCppStructOps<FFMODLocalizedBankTable>);
	}
...
static struct FScriptStruct_FMODStudio_StaticRegisterNativesFFMODLocalizedBankRow
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("FMODLocalizedBankRow")),new UScriptStruct::TCppStructOps<FFMODLocalizedBankRow>);
	}
