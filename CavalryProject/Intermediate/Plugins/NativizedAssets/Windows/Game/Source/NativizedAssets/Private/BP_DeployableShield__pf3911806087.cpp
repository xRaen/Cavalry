...
#include "BP_DeployableShield__pf3911806087.h"
...
#include "BP_Shield__pf3911806087.h"
...
ABP_DeployableShield_C__pf3911806087::ABP_DeployableShield_C__pf3911806087(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__ShieldSpawnPoint__pf = CreateDefaultSubobject<USceneComponent>(TEXT("ShieldSpawnPoint"));
	...
	bpv__Tool_SkM__pf->AnimClass = UABP_Tool_ShieldBase_Whitebox_01_C__pf2439319826::StaticClass();
	bpv__Tool_SkM__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(ABP_DeployableShield_C__pf3911806087::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Tool_SkM__pf->VisibilityBasedAnimTickOption = EVisibilityBasedAnimTickOption::AlwaysTickPoseAndRefreshBones;
	bpv__Tool_SkM__pf->BodyInstance.LoadProfileData(false);
	...
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Tool_SkM__pf), false, 0));
	auto& __Local__2 = (*(AccessPrivateProperty<FVector >((bpv__MagnetCollision__pf), UBoxComponent::__PPO__BoxExtent() )));
	__Local__2 = FVector(20.588943, 27.347301, 4.961476);
	bpv__MagnetCollision__pf->BodyInstance.LoadProfileData(false);
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__MagnetCollision__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(1.360229, 0.000000, 3.338226);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__MagnetCollision__pf), true, 0));
	bpv__ShieldSpawnPoint__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ShieldSpawnPoint__pf->AttachToComponent(bpv__Tool_SkM__pf, FAttachmentTransformRules::KeepRelativeTransform );
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__ShieldSpawnPoint__pf), false, 0));
	bpv__Audio__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Audio__pf->AttachToComponent(bpv__Tool_SkM__pf, FAttachmentTransformRules::KeepRelativeTransform );
	...
	bpv__BoxxCollider__pfT->AttachToComponent(bpv__Tool_SkM__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__BoxxCollider__pfT), UBoxComponent::__PPO__BoxExtent() )));
	__Local__4 = FVector(20.588943, 27.347301, 4.961476);
	bpv__BoxxCollider__pfT->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__5 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__BoxxCollider__pfT->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__5 = ECollisionChannel::ECC_GameTraceChannel6;
	bpv__BoxxCollider__pfT->BodyInstance.bNotifyRigidBodyCollision = true;
	auto& __Local__6 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__BoxxCollider__pfT->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__7.AddUninitialized(10);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__7.GetData(), 10);
	...
	__Local__15.Channel = FName(TEXT("PlayerCollision"));
	...
	bpv__BoxxCollider__pfT->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__18 = (*(AccessPrivateProperty<FVector >((bpv__BoxxCollider__pfT), USceneComponent::__PPO__RelativeLocation() )));
	__Local__18 = FVector(1.360229, 0.000000, 3.338226);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__BoxxCollider__pfT), true, 0));
	bpv__OwnerGear__pf = nullptr;
	bpv__ThrowLocation__pf = FVector(0.000000, 0.000000, 0.000000);
...
void ABP_DeployableShield_C__pf3911806087::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__ShieldSpawnPoint__pf)
	{
		bpv__ShieldSpawnPoint__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Audio__pf)
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_DeployableShield_C__pf3911806087::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UABP_Tool_ShieldBase_Whitebox_01_C__pf2439319826::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(ABP_Tool_Base_C__pf3911806087::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(ABP_Shield_C__pf3911806087::StaticClass());
	...
	__Local__24.ComponentPropertyName = FName(TEXT("Box Collider"));
	__Local__24.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__24.FunctionNameToBind = FName(TEXT("BndEvt__BP_DeployableShield_Box Collider_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_DeployableShield_C__pf3911806087::bpf__ExecuteUbergraph_BP_DeployableShield__pf_0(int32 bpp__EntryPoint__pf)
{
		...
		case 19:
			{
				if(::IsValid(bpv__Tool_SkM__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__Tool_SkM__pf->USceneComponent::K2_GetComponentLocation();
				}
				...
				UKismetMathLibrary::BreakVector(bpv__ThrowLocation__pf, /*out*/ b1l__CallFunc_BreakVector_X_1__pf, /*out*/ b1l__CallFunc_BreakVector_Y_1__pf, /*out*/ b1l__CallFunc_BreakVector_Z_1__pf);
				bpfv__CallFunc_MakeVector_ReturnValue_1__pf = UKismetMathLibrary::MakeVector(b1l__CallFunc_BreakVector_X_1__pf, b1l__CallFunc_BreakVector_Y_1__pf, 0.000000);
				...
				if(::IsValid(bpv__Tool_SkM__pf))
				{
					bpv__Tool_SkM__pf->USceneComponent::K2_SetWorldRotation(bpfv__CallFunc_FindLookAtRotation_ReturnValue__pf, false, /*out*/ b1l__CallFunc_K2_SetWorldRotation_SweepHitResult__pf, false);
				}
				__CurrentState = 3;
				break;
			}
...
void ABP_DeployableShield_C__pf3911806087::bpf__ExecuteUbergraph_BP_DeployableShield__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	if(::IsValid(bpv__Tool_SkM__pf))
	{
		bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_2__pf = bpv__Tool_SkM__pf->USceneComponent::K2_GetComponentLocation();
	}
	bpv__ThrowLocation__pf = bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_2__pf;
...
void ABP_DeployableShield_C__pf3911806087::bpf__ExecuteUbergraph_BP_DeployableShield__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	ABP_Shield_C__pf3911806087* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	FVector bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf(EForceInit::ForceInit);
	check(bpp__EntryPoint__pf == 9);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__Tool_SkM__pf))
	{
		bpv__Tool_SkM__pf->USkeletalMeshComponent::PlayAnimation(CastChecked<UAnimationAsset>(CastChecked<UDynamicClass>(ABP_DeployableShield_C__pf3911806087::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed), false);
	}
	if(::IsValid(bpv__Tool_SkM__pf))
	{
		bpfv__CallFunc_GetRelativeTransform_ReturnValue__pf = bpv__Tool_SkM__pf->USceneComponent::GetRelativeTransform();
	}
	bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, ABP_Shield_C__pf3911806087::StaticClass(), bpfv__CallFunc_GetRelativeTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
	if(::IsValid(bpv__Tool_SkM__pf))
	{
		bpfv__CallFunc_GetRelativeTransform_ReturnValue__pf = bpv__Tool_SkM__pf->USceneComponent::GetRelativeTransform();
	}
	bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<ABP_Shield_C__pf3911806087>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_GetRelativeTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
	if(::IsValid(bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf))
	{
		bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf->AActor::K2_AttachToActor(this, FName(TEXT("None")), EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, false);
	}
	if(::IsValid(bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf) && ::IsValid(bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf->bpv__SkM_Shield__pf))
	{
		bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf->bpv__SkM_Shield__pf->USkeletalMeshComponent::PlayAnimation(CastChecked<UAnimationAsset>(CastChecked<UDynamicClass>(ABP_DeployableShield_C__pf3911806087::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), false);
	}
	if(::IsValid(bpv__GrabbableObjectSocket__pf))
	{
		bpv__GrabbableObjectSocket__pf->bpv__ComponentActive__pf = false;
	}
	if(::IsValid(bpv__Tool_SkM__pf))
	{
		bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf = bpv__Tool_SkM__pf->USceneComponent::K2_GetComponentLocation();
	}
	UGameplayStatics::PlaySoundAtLocation(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(ABP_DeployableShield_C__pf3911806087::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf, FRotator(0.000000,0.000000,0.000000), 1.000000, 1.000000, 0.000000, ((USoundAttenuation*)nullptr), ((USoundConcurrency*)nullptr), ((AActor*)nullptr));
	return; //KCST_EndOfThread
}
void ABP_DeployableShield_C__pf3911806087::bpf__Release__pf(EControllerHand bpp__NewParam__pf)
{
	b1l__K2Node_Event_NewParam__pf = bpp__NewParam__pf;
	bpf__ExecuteUbergraph_BP_DeployableShield__pf_1(23);
}
void ABP_DeployableShield_C__pf3911806087::bpf__BndEvt__BP_DeployableShield_BoxxCollider_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature__pfT(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BP_DeployableShield__pf_0(20);
}
void ABP_DeployableShield_C__pf3911806087::bpf__DeployBase__pf()
{
	bpf__ExecuteUbergraph_BP_DeployableShield__pf_2(9);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_DeployableShield_C__pf3911806087::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{236, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  SkeletalMesh /Game/Meshes/Placeholder/War/Tool_ShieldBase_Whitebox_01.Tool_ShieldBase_Whitebox_01 
		...
		{237, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  AnimSequence /Game/Meshes/Placeholder/War/Tool_Shield_Whitebox_01_Opening.Tool_Shield_Whitebox_01_Opening 
		{238, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  SoundWave /Game/SFX/Tools/Cavalry_shield_demo_21st_impact.Cavalry_shield_demo_21st_impact 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_DeployableShield_C__pf3911806087::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{182, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/Tools/BP_Tool_Base.BP_Tool_Base_C 
		...
		{239, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.AudioComponent 
		...
		{232, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  SkeletalMesh /Game/Meshes/Placeholder/War/Tool_Shield_Whitebox_01.Tool_Shield_Whitebox_01 
		...
		{240, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  AnimBlueprintGeneratedClass /Game/Meshes/Placeholder/War/ABP_Tool_ShieldBase_Whitebox_01.ABP_Tool_ShieldBase_Whitebox_01_C 
		{241, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/Tools/BP_Shield.BP_Shield_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_DeployableShield_C__pf3911806087
{
	FRegisterHelper__ABP_DeployableShield_C__pf3911806087()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Tools/BP_DeployableShield"), &ABP_DeployableShield_C__pf3911806087::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_DeployableShield_C__pf3911806087 Instance;
};
FRegisterHelper__ABP_DeployableShield_C__pf3911806087 FRegisterHelper__ABP_DeployableShield_C__pf3911806087::Instance;
