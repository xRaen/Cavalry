...
ABP_MainMenu_Actor_C__pf3256655095::ABP_MainMenu_Actor_C__pf3256655095(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__Menu_Origin__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Menu_Origin"));
	bpv__Panel_Center_Loc__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Panel_Center_Loc"));
	bpv__MM_Center__pf = CreateDefaultSubobject<UWidgetComponent>(TEXT("MM_Center"));
	bpv__Panel_Right_Loc__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Panel_Right_Loc"));
	...
	bpv__Menu_Origin__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Menu_Origin__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Menu_Origin__pf), true, 0));
	bpv__Panel_Center_Loc__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Panel_Center_Loc__pf->AttachToComponent(bpv__Menu_Origin__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<FVector >((bpv__Panel_Center_Loc__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__2 = FVector(400.000000, 0.000000, 375.000000);
	auto& __Local__3 = (*(AccessPrivateProperty<FRotator >((bpv__Panel_Center_Loc__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__3 = FRotator(0.000000, 180.000000, 0.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Panel_Center_Loc__pf), true, 0));
	bpv__MM_Center__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__MM_Center__pf->AttachToComponent(bpv__Panel_Center_Loc__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__4 = (*(AccessPrivateProperty<TSubclassOf<UUserWidget>  >((bpv__MM_Center__pf), UWidgetComponent::__PPO__WidgetClass() )));
	__Local__4 = UMM_Center_Panel_C__pf3256655095::StaticClass();
	auto& __Local__5 = (*(AccessPrivateProperty<FIntPoint >((bpv__MM_Center__pf), UWidgetComponent::__PPO__DrawSize() )));
	__Local__5.X = 1800;
	__Local__5.Y = 1000;
	auto& __Local__6 = (*(AccessPrivateProperty<EWidgetGeometryMode >((bpv__MM_Center__pf), UWidgetComponent::__PPO__GeometryMode() )));
	__Local__6 = EWidgetGeometryMode::Cylinder;
	auto& __Local__7 = (*(AccessPrivateProperty<float >((bpv__MM_Center__pf), UWidgetComponent::__PPO__CylinderArcAngle() )));
	__Local__7 = 100.000000f;
	auto& __Local__8 = (*(AccessPrivateProperty<FVector >((bpv__MM_Center__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__8 = FVector(0.750000, 0.750000, 0.750000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__MM_Center__pf), true, 0));
	bpv__Panel_Right_Loc__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Panel_Right_Loc__pf->AttachToComponent(bpv__Menu_Origin__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__9 = (*(AccessPrivateProperty<FVector >((bpv__Panel_Right_Loc__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__9 = FVector(290.000000, 480.000000, 375.000000);
	auto& __Local__10 = (*(AccessPrivateProperty<FRotator >((bpv__Panel_Right_Loc__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__10 = FRotator(0.000000, 200.000000, 0.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Panel_Right_Loc__pf), true, 0));
...
void ABP_MainMenu_Actor_C__pf3256655095::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__Menu_Origin__pf)
	{
		bpv__Menu_Origin__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Panel_Center_Loc__pf)
	{
		bpv__Panel_Center_Loc__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__MM_Center__pf)
	{
		bpv__MM_Center__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Panel_Right_Loc__pf)
	{
		bpv__Panel_Right_Loc__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_MainMenu_Actor_C__pf3256655095::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UMM_Center_Panel_C__pf3256655095::StaticClass());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_MainMenu_Actor_C__pf3256655095::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_MainMenu_Actor_C__pf3256655095::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{23, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/Engine.PointerToUberGraphFrame 
		...
		{206, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/Main_Menu/MM_Center_Panel.MM_Center_Panel_C 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_MainMenu_Actor_C__pf3256655095
{
	FRegisterHelper__ABP_MainMenu_Actor_C__pf3256655095()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/Main_Menu/BP_MainMenu_Actor"), &ABP_MainMenu_Actor_C__pf3256655095::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_MainMenu_Actor_C__pf3256655095 Instance;
};
FRegisterHelper__ABP_MainMenu_Actor_C__pf3256655095 FRegisterHelper__ABP_MainMenu_Actor_C__pf3256655095::Instance;
