...
ABPC_War_C__pf1490413170::ABPC_War_C__pf1490413170(const FObjectInitializer& ObjectInitializer) : Super()
{
...
void ABPC_War_C__pf1490413170::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABPC_War_C__pf1490413170::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABPC_War_C__pf1490413170::bpf__ExecuteUbergraph_BPC_War__pf_0(int32 bpp__EntryPoint__pf)
{
	ABPC_War_C__pf1490413170* bpfv__CallFunc_GetActorOfClass_ReturnValue__pf{};
	bool bpfv__CallFunc_IsValid_ReturnValue__pf{};
	ABP_PlayerCharacter_Base_C__pf1490413170* bpfv__CallFunc_GetActorOfClass_ReturnValue_1__pf{};
	ABP_PlayerCharacter_Base_C__pf1490413170* bpfv__CallFunc_GetActorOfClass_ReturnValue_2__pf{};
	bool bpfv__CallFunc_IsValid_ReturnValue_1__pf{};
	bool bpfv__CallFunc_IsValid_ReturnValue_2__pf{};
	ABP_PlayerCharacter_Base_C__pf1490413170* bpfv__CallFunc_GetActorOfClass_ReturnValue_3__pf{};
	...
	do
	{
		...
		case 3:
			{
				bpfv__CallFunc_GetActorOfClass_ReturnValue__pf = CastChecked<ABPC_War_C__pf1490413170>(UGameplayStatics::GetActorOfClass(this, GetClass()), ECastCheckedType::NullAllowed);
			}
		case 4:
			{
		...
		case 5:
			{
				...
				{
					bpfv__CallFunc_GetActorOfClass_ReturnValue__pf->bpv__maxShields__pf = 150;
				}
			}
		case 6:
			{
				int32  __Local__19 = 0;
				bpv__currentShields__pf = ((::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue__pf)) ? (bpfv__CallFunc_GetActorOfClass_ReturnValue__pf->bpv__maxShields__pf) : (__Local__19));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 7:
			{
				bpfv__CallFunc_GetActorOfClass_ReturnValue_1__pf = CastChecked<ABP_PlayerCharacter_Base_C__pf1490413170>(UGameplayStatics::GetActorOfClass(this, CastChecked<UClass>(CastChecked<UDynamicClass>(ABPC_War_C__pf1490413170::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed)), ECastCheckedType::NullAllowed);
			}
		case 8:
			{
				bpfv__CallFunc_IsValid_ReturnValue_2__pf = UKismetSystemLibrary::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue_1__pf);
		...
		case 9:
			{
				if(::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue_1__pf))
				{
					bpfv__CallFunc_GetActorOfClass_ReturnValue_1__pf->bpv__maxShields__pf = 150;
				}
			}
		case 10:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue_1__pf))
				{
					bpfv__CallFunc_GetActorOfClass_ReturnValue_1__pf->bpv__currentShields__pf = ((::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue_1__pf)) ? (bpfv__CallFunc_GetActorOfClass_ReturnValue_1__pf->bpv__maxShields__pf) : (__Local__20));
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 11:
			{
				bpfv__CallFunc_GetActorOfClass_ReturnValue_2__pf = CastChecked<ABP_PlayerCharacter_Base_C__pf1490413170>(UGameplayStatics::GetActorOfClass(this, CastChecked<UClass>(CastChecked<UDynamicClass>(ABPC_War_C__pf1490413170::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed)), ECastCheckedType::NullAllowed);
			}
		case 12:
			{
				bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue_2__pf);
		...
		case 13:
			{
				if(::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue_2__pf))
				{
					bpfv__CallFunc_GetActorOfClass_ReturnValue_2__pf->bpv__maxShields__pf = 150;
				}
			}
		case 14:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue_2__pf))
				{
					bpfv__CallFunc_GetActorOfClass_ReturnValue_2__pf->bpv__currentShields__pf = ((::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue_2__pf)) ? (bpfv__CallFunc_GetActorOfClass_ReturnValue_2__pf->bpv__maxShields__pf) : (__Local__21));
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 15:
			{
				bpfv__CallFunc_GetActorOfClass_ReturnValue_3__pf = CastChecked<ABP_PlayerCharacter_Base_C__pf1490413170>(UGameplayStatics::GetActorOfClass(this, CastChecked<UClass>(CastChecked<UDynamicClass>(ABPC_War_C__pf1490413170::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed)), ECastCheckedType::NullAllowed);
			}
		case 16:
			{
				bpfv__CallFunc_IsValid_ReturnValue_3__pf = UKismetSystemLibrary::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue_3__pf);
		...
		case 17:
			{
				if(::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue_3__pf))
				{
					bpfv__CallFunc_GetActorOfClass_ReturnValue_3__pf->bpv__maxShields__pf = 150;
				}
			}
		case 18:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue_3__pf))
				{
					bpfv__CallFunc_GetActorOfClass_ReturnValue_3__pf->bpv__currentShields__pf = ((::IsValid(bpfv__CallFunc_GetActorOfClass_ReturnValue_3__pf)) ? (bpfv__CallFunc_GetActorOfClass_ReturnValue_3__pf->bpv__maxShields__pf) : (__Local__22));
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
...
void ABPC_War_C__pf1490413170::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BPC_War__pf_0(19);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABPC_War_C__pf1490413170::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABPC_War_C__pf1490413170::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{121, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/Characters/BP_PlayerCharacter_Base.BP_PlayerCharacter_Base_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABPC_War_C__pf1490413170
{
	FRegisterHelper__ABPC_War_C__pf1490413170()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Characters/BPC_War"), &ABPC_War_C__pf1490413170::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABPC_War_C__pf1490413170 Instance;
};
FRegisterHelper__ABPC_War_C__pf1490413170 FRegisterHelper__ABPC_War_C__pf1490413170::Instance;
