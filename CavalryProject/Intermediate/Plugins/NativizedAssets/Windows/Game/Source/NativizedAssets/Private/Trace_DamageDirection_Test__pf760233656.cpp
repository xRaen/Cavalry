...
#include "Trace_DamageDirection_Test__pf760233656.h"
...
ATrace_DamageDirection_Test_C__pf760233656::ATrace_DamageDirection_Test_C__pf760233656(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__Trace_Origin__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Trace_Origin"));
	bpv__Direction__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Direction"));
	...
	bpv__Trace_Origin__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Trace_Origin__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Trace_Origin__pf), true, 0));
	bpv__Direction__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Direction__pf->AttachToComponent(bpv__Trace_Origin__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Direction__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ATrace_DamageDirection_Test_C__pf760233656::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Direction__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Direction__pf->OverrideMaterials.Reserve(1);
	bpv__Direction__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ATrace_DamageDirection_Test_C__pf760233656::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__Direction__pf->SetCollisionProfileName(FName(TEXT("NoCollision")));
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__Direction__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(60.000000, 0.000000, 0.000000);
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__Direction__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__4 = FVector(100.000000, 1.000000, 1.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Direction__pf), true, 0));
	bpv__CanTracex__pfzy = true;
...
void ATrace_DamageDirection_Test_C__pf760233656::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__Trace_Origin__pf)
	{
		bpv__Trace_Origin__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Direction__pf)
	{
		bpv__Direction__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ATrace_DamageDirection_Test_C__pf760233656::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ATrace_DamageDirection_Test_C__pf760233656::bpf__ExecuteUbergraph_Trace_DamageDirection_Test__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 10:
			{
				if(::IsValid(bpv__Trace_Origin__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__Trace_Origin__pf->USceneComponent::K2_GetComponentLocation();
				}
				bpfv__CallFunc_MakeLiteralByte_ReturnValue__pf = UKismetSystemLibrary::MakeLiteralByte(8);
				b0l__K2Node_MakeArray_Array__pf.SetNum(1, true);
				b0l__K2Node_MakeArray_Array__pf[0] = static_cast<EObjectTypeQuery>(bpfv__CallFunc_MakeLiteralByte_ReturnValue__pf);
				if(::IsValid(bpv__Direction__pf))
				{
					bpfv__CallFunc_GetForwardVector_ReturnValue__pf = bpv__Direction__pf->USceneComponent::GetForwardVector();
				}
				bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_VectorFloat(bpfv__CallFunc_GetForwardVector_ReturnValue__pf, 300.000000);
				bpfv__CallFunc_Add_VectorVector_ReturnValue__pf = UKismetMathLibrary::Add_VectorVector(bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf);
				bpfv__CallFunc_LineTraceSingleForObjects_ReturnValue__pf = UKismetSystemLibrary::LineTraceSingleForObjects(this, bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_Add_VectorVector_ReturnValue__pf, b0l__K2Node_MakeArray_Array__pf, false, b0l__Temp_object_Variable__pf, EDrawDebugTrace::Persistent, /*out*/ b0l__CallFunc_LineTraceSingleForObjects_OutHit__pf, true, FLinearColor(1.000000,0.000000,0.000000,1.000000), FLinearColor(0.000000,1.000000,0.000000,1.000000), 5.000000);
			}
		case 11:
			{
				...
				b0l__K2Node_DynamicCast_AsBP_Player_Character_Base_1__pf = Cast<ABP_PlayerCharacter_Base_C__pf1490413170>(b0l__CallFunc_BreakHitResult_HitActor__pf);
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsBP_Player_Character_Base_1__pf != nullptr);;
		...
		case 12:
			{
				ABP_HorsemenHUD_C__pf760233656*  __Local__6 = ((ABP_HorsemenHUD_C__pf760233656*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsBP_Player_Character_Base_1__pf)) ? (b0l__K2Node_DynamicCast_AsBP_Player_Character_Base_1__pf->bpv__WidgetHandler__pf) : (__Local__6)));
		...
		case 13:
			{
				if(::IsValid(bpv__Trace_Origin__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf = bpv__Trace_Origin__pf->USceneComponent::K2_GetComponentLocation();
				}
				if(::IsValid(b0l__K2Node_DynamicCast_AsBP_Player_Character_Base_1__pf) && ::IsValid(b0l__K2Node_DynamicCast_AsBP_Player_Character_Base_1__pf->bpv__WidgetHandler__pf))
				{
					IBPI_DamageDirection_C::Execute_bpf__Damage_Source__pf(b0l__K2Node_DynamicCast_AsBP_Player_Character_Base_1__pf->bpv__WidgetHandler__pf , bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf);
				}
			}
		case 14:
			{
				bpv__CanTracex__pfzy = false;
				__CurrentState = -1;
				break;
			}
		case 15:
			{
				UKismetSystemLibrary::Delay(this, 5.000000, FLatentActionInfo(1, 47626081, TEXT("ExecuteUbergraph_Trace_DamageDirection_Test_0"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void ATrace_DamageDirection_Test_C__pf760233656::bpf__ExecuteUbergraph_Trace_DamageDirection_Test__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	bpv__Player__pf = b0l__K2Node_DynamicCast_AsBP_Player_Character_Base__pf;
	return; //KCST_EndOfThread
}
void ATrace_DamageDirection_Test_C__pf760233656::bpf__ExecuteUbergraph_Trace_DamageDirection_Test__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 4);
	return; //KCST_EndOfThread
}
void ATrace_DamageDirection_Test_C__pf760233656::bpf__ExecuteUbergraph_Trace_DamageDirection_Test__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 3);
	return; //KCST_EndOfThread
}
void ATrace_DamageDirection_Test_C__pf760233656::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_Trace_DamageDirection_Test__pf_0(8);
}
void ATrace_DamageDirection_Test_C__pf760233656::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Trace_DamageDirection_Test__pf_1(5);
}
void ATrace_DamageDirection_Test_C__pf760233656::bpf__Damage_Source__pf(FVector bpp__Source__pf)
{
	b0l__K2Node_Event_Source__pf = bpp__Source__pf;
	bpf__ExecuteUbergraph_Trace_DamageDirection_Test__pf_2(4);
}
void ATrace_DamageDirection_Test_C__pf760233656::bpf__Player_Was_Hit__pf(bool bpp__CurrentlyHit__pf)
{
	b0l__K2Node_Event_CurrentlyHit__pf = bpp__CurrentlyHit__pf;
	bpf__ExecuteUbergraph_Trace_DamageDirection_Test__pf_3(3);
}
PRAGMA_DISABLE_OPTIMIZATION
void ATrace_DamageDirection_Test_C__pf760233656::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{149, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/Materials/Whitebox/M_Red.M_Red 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ATrace_DamageDirection_Test_C__pf760233656::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ATrace_DamageDirection_Test_C__pf760233656
{
	FRegisterHelper__ATrace_DamageDirection_Test_C__pf760233656()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/Widgets/Damage_Display/Trace_DamageDirection_Test"), &ATrace_DamageDirection_Test_C__pf760233656::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ATrace_DamageDirection_Test_C__pf760233656 Instance;
};
FRegisterHelper__ATrace_DamageDirection_Test_C__pf760233656 FRegisterHelper__ATrace_DamageDirection_Test_C__pf760233656::Instance;
