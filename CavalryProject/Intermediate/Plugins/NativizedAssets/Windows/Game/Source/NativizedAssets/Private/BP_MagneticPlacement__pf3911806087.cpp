...
ABP_MagneticPlacement_C__pf3911806087::ABP_MagneticPlacement_C__pf3911806087(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__CollisionxDetection__pfT = CreateDefaultSubobject<USphereComponent>(TEXT("Collision Detection"));
	RootComponent = bpv__CollisionxDetection__pfT;
	bpv__CollisionxDetection__pfT->CreationMethod = EComponentCreationMethod::Native;
	auto& __Local__0 = (*(AccessPrivateProperty<float >((bpv__CollisionxDetection__pfT), USphereComponent::__PPO__SphereRadius() )));
	__Local__0 = 5.000000f;
	bpv__CollisionxDetection__pfT->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__1 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__CollisionxDetection__pfT->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__1 = ECollisionChannel::ECC_GameTraceChannel6;
	auto& __Local__2 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__CollisionxDetection__pfT->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__3.AddUninitialized(12);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__3.GetData(), 12);
	...
	(((FBoolProperty*)__Local__16)->SetPropertyValue_InContainer((bpv__CollisionxDetection__pfT), true, 0));
	bpv__Occupied__pf = false;
	bpv__ObjectxType__pfT = E__ENUM_ObjectType__pf::NewEnumerator0;
...
void ABP_MagneticPlacement_C__pf3911806087::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__CollisionxDetection__pfT)
	{
		bpv__CollisionxDetection__pfT->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_MagneticPlacement_C__pf3911806087::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_MagneticPlacement_C__pf3911806087::bpf__ExecuteUbergraph_BP_MagneticPlacement__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void ABP_MagneticPlacement_C__pf3911806087::bpf__Magnetize__pf(AActor* bpp__Magnet__pf)
{
	b0l__K2Node_Event_Magnet__pf = bpp__Magnet__pf;
	bpf__ExecuteUbergraph_BP_MagneticPlacement__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_MagneticPlacement_C__pf3911806087::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_MagneticPlacement_C__pf3911806087::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_MagneticPlacement_C__pf3911806087
{
	FRegisterHelper__ABP_MagneticPlacement_C__pf3911806087()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Tools/BP_MagneticPlacement"), &ABP_MagneticPlacement_C__pf3911806087::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_MagneticPlacement_C__pf3911806087 Instance;
};
FRegisterHelper__ABP_MagneticPlacement_C__pf3911806087 FRegisterHelper__ABP_MagneticPlacement_C__pf3911806087::Instance;
