...
#include "Start_Mission_Breif__pf3256655095.h"
...
UStart_Mission_Breif_C__pf3256655095::UStart_Mission_Breif_C__pf3256655095(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void UStart_Mission_Breif_C__pf3256655095::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UStart_Mission_Breif_C__pf3256655095::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__2.ComponentPropertyName = FName(TEXT("StartGame"));
	__Local__2.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__2.FunctionNameToBind = FName(TEXT("BndEvt__Start_Button_StartGame_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__5->LayoutData.Offsets.Left = 50.000000f;
	__Local__5->LayoutData.Offsets.Top = 15.000000f;
	__Local__5->LayoutData.Offsets.Right = 300.000000f;
	__Local__5->LayoutData.Offsets.Bottom = 70.000000f;
	__Local__5->Parent = __Local__3;
	auto __Local__6 = NewObject<UButton>(__Local__1, TEXT("StartGame"), (EObjectFlags)0x00280008);
	__Local__6->BackgroundColor = FLinearColor(0.562748, 0.909775, 1.000000, 1.000000);
	...
	auto __Local__8 = NewObject<UButtonSlot>(__Local__6, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__8->Parent = __Local__6;
	auto __Local__9 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_0"), (EObjectFlags)0x00280008);
	__Local__9->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[27FCA68C418FB3AC83904A9670E45BB4]\", \"E419225A476CC1ACB427A08A5756690D\", \"Get Mission Brief\")")	);
...
PRAGMA_ENABLE_OPTIMIZATION
void UStart_Mission_Breif_C__pf3256655095::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__10;
	SlotNames.Append(__Local__10);
}
void UStart_Mission_Breif_C__pf3256655095::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__11;
	TArray<FDelegateRuntimeBinding>  __Local__12;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UStart_Mission_Breif_C__pf3256655095::StaticClass())->MiscConvertedSubobjects[0]), __Local__11, __Local__12);
}
void UStart_Mission_Breif_C__pf3256655095::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UStart_Mission_Breif_C__pf3256655095::bpf__ExecuteUbergraph_Start_Mission_Breif__pf_0(int32 bpp__EntryPoint__pf)
{
	UGameInstance* bpfv__CallFunc_GetGameInstance_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 3);
	// optimized KCST_UnconditionalGoto
	UKismetSystemLibrary::PrintString(this, FString(TEXT("I was clicked")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	...
	{
		b0l__K2Node_DynamicCast_AsBP_Cavalry_Game_Instance__pf->bpf__SetxGamexState__pfTT(E__EGameState__pf::NewEnumerator0, /*out*/ b0l__CallFunc_Set_Game_State_Success___pf);
	}
	// optimized KCST_UnconditionalGoto
	UKismetSystemLibrary::PrintString(this, FString(TEXT("Level Select was called")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	return; // KCST_GotoReturn
}
void UStart_Mission_Breif_C__pf3256655095::bpf__ExecuteUbergraph_Start_Mission_Breif__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 2);
	return; // KCST_GotoReturn
}
void UStart_Mission_Breif_C__pf3256655095::bpf__BndEvt__Start_Button_StartGame_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_Start_Mission_Breif__pf_0(3);
}
void UStart_Mission_Breif_C__pf3256655095::bpf__SelectxPlayer__pfT(UClass* bpp__PlayerInput__pf)
{
	b0l__K2Node_Event_PlayerInput__pf = bpp__PlayerInput__pf;
	bpf__ExecuteUbergraph_Start_Mission_Breif__pf_1(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void UStart_Mission_Breif_C__pf3256655095::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UStart_Mission_Breif_C__pf3256655095::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UStart_Mission_Breif_C__pf3256655095
{
	FRegisterHelper__UStart_Mission_Breif_C__pf3256655095()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/Main_Menu/Start_Mission_Breif"), &UStart_Mission_Breif_C__pf3256655095::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UStart_Mission_Breif_C__pf3256655095 Instance;
};
FRegisterHelper__UStart_Mission_Breif_C__pf3256655095 FRegisterHelper__UStart_Mission_Breif_C__pf3256655095::Instance;
