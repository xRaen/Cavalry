...
class UButton;
class UTextBlock;
#include "Widget_LevelSelect_Button__pf3256655095.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/HUD/Main_Menu/Widget_LevelSelect_Button.Widget_LevelSelect_Button_C", OverrideNativeName="Widget_LevelSelect_Button_C"))
class UWidget_LevelSelect_Button_C__pf3256655095 : public UUserWidget
{
public:
	GENERATED_BODY()
	UDELEGATE(meta=(OverrideNativeName="OnLevelSelected__DelegateSignature"))
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnLevelSelected__pf__Widget_LevelSelect_Button_C__pf__MulticastDelegate , int32 , bpp__Index__pf);
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_LevelSelectionButton", Category="Widget_LevelSelect_Button", OverrideNativeName="Button_LevelSelectionButton"))
	UButton* bpv__Button_LevelSelectionButton__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="TextBlock_LevelName", Category="Widget_LevelSelect_Button", OverrideNativeName="TextBlock_LevelName"))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, BlueprintAssignable, BlueprintCallable, meta=(DisplayName="On Level Selected", Category="Default", MultiLine="true", OverrideNativeName="OnLevelSelected"))
	FOnLevelSelected__pf__Widget_LevelSelect_Button_C__pf__MulticastDelegate bpv__OnLevelSelected__pf;
	...
	UWidget_LevelSelect_Button_C__pf3256655095(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Widget_LevelSelect_Button__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Widget_LevelSelect_Button__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Widget_LevelSelect_Button__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Widget_LevelSelect_Button__pf_3(int32 bpp__EntryPoint__pf);
