...
#include "HUD_Overlay__pf1982152804.h"
#include "ObjectivePointer__pf2435026734.h"
#include "Widg_MissionText__pf1982152804.h"
...
ABP_HorsemenHUD_C__pf760233656::ABP_HorsemenHUD_C__pf760233656(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__SpawnLocation__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("SpawnLocation"));
	bpv__Overlay_Loc__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Overlay_Loc"));
	bpv__HUD_Overlay__pf = CreateDefaultSubobject<UWidgetComponent>(TEXT("HUD_Overlay"));
	bpv__Objective_Loc__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Objective_Loc"));
	bpv__ObjectivePointer__pf = CreateDefaultSubobject<UWidgetComponent>(TEXT("ObjectivePointer"));
	bpv__MissionText_Loc__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("MissionText_Loc"));
	bpv__MissionText__pf = CreateDefaultSubobject<UWidgetComponent>(TEXT("MissionText"));
	...
	__Local__0 = FVector(0.100000, 0.100000, 0.100000);
	...
	bpv__SpawnLocation__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__SpawnLocation__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__SpawnLocation__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(0.000000, 0.000000, 30.000000);
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__SpawnLocation__pf), true, 0));
	bpv__Overlay_Loc__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Overlay_Loc__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__Overlay_Loc__pf), true, 0));
	bpv__HUD_Overlay__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__HUD_Overlay__pf->AttachToComponent(bpv__Overlay_Loc__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__4 = (*(AccessPrivateProperty<TSubclassOf<UUserWidget>  >((bpv__HUD_Overlay__pf), UWidgetComponent::__PPO__WidgetClass() )));
	__Local__4 = UHUD_Overlay_C__pf1982152804::StaticClass();
	auto& __Local__5 = (*(AccessPrivateProperty<FIntPoint >((bpv__HUD_Overlay__pf), UWidgetComponent::__PPO__DrawSize() )));
	__Local__5.X = 1920;
	__Local__5.Y = 1080;
	auto& __Local__6 = (*(AccessPrivateProperty<FLinearColor >((bpv__HUD_Overlay__pf), UWidgetComponent::__PPO__TintColorAndOpacity() )));
	__Local__6 = FLinearColor(0.200000, 0.200000, 0.200000, 0.600000);
	auto& __Local__7 = (*(AccessPrivateProperty<EWidgetGeometryMode >((bpv__HUD_Overlay__pf), UWidgetComponent::__PPO__GeometryMode() )));
	__Local__7 = EWidgetGeometryMode::Cylinder;
	auto& __Local__8 = (*(AccessPrivateProperty<float >((bpv__HUD_Overlay__pf), UWidgetComponent::__PPO__CylinderArcAngle() )));
	__Local__8 = 15.000000f;
	bpv__HUD_Overlay__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__HUD_Overlay__pf->OverrideMaterials.Reserve(1);
	bpv__HUD_Overlay__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_HorsemenHUD_C__pf760233656::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
	bpv__HUD_Overlay__pf->bOnlyOwnerSee = true;
	auto& __Local__9 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__HUD_Overlay__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__10.AddUninitialized(10);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__10.GetData(), 10);
	...
	__Local__15.Channel = FName(TEXT("PhysicsBody"));
	...
	__Local__17.Channel = FName(TEXT("Destructible"));
	...
	auto& __Local__19 = __Local__10[8];
	__Local__19.Channel = FName(TEXT("Enemy"));
	__Local__19.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__20 = __Local__10[9];
	__Local__20.Channel = FName(TEXT("Visibility"));
	__Local__20.Response = ECollisionResponse::ECR_Overlap;
	bpv__HUD_Overlay__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__21 = (*(AccessPrivateProperty<FVector >((bpv__HUD_Overlay__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__21 = FVector(300.000000, 0.000048, -10.000000);
	auto& __Local__22 = (*(AccessPrivateProperty<FRotator >((bpv__HUD_Overlay__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__22 = FRotator(0.000000, -179.999954, 0.000000);
	auto& __Local__23 = (*(AccessPrivateProperty<FVector >((bpv__HUD_Overlay__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__23 = FVector(0.490000, 0.490000, 0.490000);
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__HUD_Overlay__pf), true, 0));
	bpv__Objective_Loc__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Objective_Loc__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__Objective_Loc__pf), true, 0));
	bpv__ObjectivePointer__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ObjectivePointer__pf->AttachToComponent(bpv__Objective_Loc__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__24 = (*(AccessPrivateProperty<TSubclassOf<UUserWidget>  >((bpv__ObjectivePointer__pf), UWidgetComponent::__PPO__WidgetClass() )));
	__Local__24 = UObjectivePointer_C__pf2435026734::StaticClass();
	auto& __Local__25 = (*(AccessPrivateProperty<FIntPoint >((bpv__ObjectivePointer__pf), UWidgetComponent::__PPO__DrawSize() )));
	__Local__25.X = 1920;
	__Local__25.Y = 1080;
	bpv__ObjectivePointer__pf->bOnlyOwnerSee = true;
	auto& __Local__26 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__ObjectivePointer__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__27.AddUninitialized(10);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__27.GetData(), 10);
	...
	auto& __Local__35 = __Local__27[7];
	__Local__35.Channel = FName(TEXT("Visibility"));
	__Local__35.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__36 = __Local__27[8];
	__Local__36.Channel = FName(TEXT("Enemy"));
	__Local__36.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__37 = __Local__27[9];
	__Local__37.Channel = FName(TEXT("PlayerCollision"));
	__Local__37.Response = ECollisionResponse::ECR_Overlap;
	bpv__ObjectivePointer__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__38 = (*(AccessPrivateProperty<FVector >((bpv__ObjectivePointer__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__38 = FVector(205.962585, -0.000021, -145.150299);
	auto& __Local__39 = (*(AccessPrivateProperty<FRotator >((bpv__ObjectivePointer__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__39 = FRotator(68.399834, 180.000000, 0.000000);
	auto& __Local__40 = (*(AccessPrivateProperty<FVector >((bpv__ObjectivePointer__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__40 = FVector(0.070000, 0.070000, 0.070000);
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__ObjectivePointer__pf), true, 0));
	bpv__MissionText_Loc__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__MissionText_Loc__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__41 = (*(AccessPrivateProperty<FVector >((bpv__MissionText_Loc__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__41 = FVector(301.938965, 73.462029, 20.616093);
	auto& __Local__42 = (*(AccessPrivateProperty<FRotator >((bpv__MissionText_Loc__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__42 = FRotator(0.000000, 200.000107, 0.000000);
	auto& __Local__43 = (*(AccessPrivateProperty<FVector >((bpv__MissionText_Loc__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__43 = FVector(0.200000, 0.200000, 0.200000);
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__MissionText_Loc__pf), true, 0));
	bpv__MissionText__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__MissionText__pf->AttachToComponent(bpv__MissionText_Loc__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__44 = (*(AccessPrivateProperty<TSubclassOf<UUserWidget>  >((bpv__MissionText__pf), UWidgetComponent::__PPO__WidgetClass() )));
	__Local__44 = UWidg_MissionText_C__pf1982152804::StaticClass();
	auto& __Local__45 = (*(AccessPrivateProperty<FIntPoint >((bpv__MissionText__pf), UWidgetComponent::__PPO__DrawSize() )));
	__Local__45.X = 800;
	auto& __Local__46 = (*(AccessPrivateProperty<EWidgetGeometryMode >((bpv__MissionText__pf), UWidgetComponent::__PPO__GeometryMode() )));
	__Local__46 = EWidgetGeometryMode::Cylinder;
	auto& __Local__47 = (*(AccessPrivateProperty<float >((bpv__MissionText__pf), UWidgetComponent::__PPO__CylinderArcAngle() )));
	__Local__47 = 10.000000f;
	auto& __Local__48 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__MissionText__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	auto& __Local__49 = (*(AccessPrivateProperty<TArray<FResponseChannel> >(&(__Local__48), FCollisionResponse::__PPO__ResponseArray() )));
	__Local__49 = TArray<FResponseChannel> ();
	__Local__49.AddUninitialized(10);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__49.GetData(), 10);
	...
	auto& __Local__54 = __Local__49[4];
	__Local__54.Channel = FName(TEXT("PhysicsBody"));
	__Local__54.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__55 = __Local__49[5];
	__Local__55.Channel = FName(TEXT("Vehicle"));
	__Local__55.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__56 = __Local__49[6];
	__Local__56.Channel = FName(TEXT("Destructible"));
	__Local__56.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__57 = __Local__49[7];
	__Local__57.Channel = FName(TEXT("Visibility"));
	__Local__57.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__58 = __Local__49[8];
	__Local__58.Channel = FName(TEXT("Enemy"));
	__Local__58.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__59 = __Local__49[9];
	__Local__59.Channel = FName(TEXT("PlayerCollision"));
	__Local__59.Response = ECollisionResponse::ECR_Overlap;
	bpv__MissionText__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__60 = (*(AccessPrivateProperty<FVector >((bpv__MissionText__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__60 = FVector(-33.671455, -144.500824, 0.003242);
	auto& __Local__61 = (*(AccessPrivateProperty<FRotator >((bpv__MissionText__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__61 = FRotator(0.000000, -10.000031, 0.000000);
	static TWeakFieldPtr<FProperty> __Local__63{};
	const FProperty* __Local__62 = __Local__63.Get();
	if (nullptr == __Local__62)
	{
		__Local__62 = (USceneComponent::StaticClass())->FindPropertyByName(FName(TEXT("bVisible")));
		check(__Local__62);
		__Local__63 = __Local__62;
	}
	(((FBoolProperty*)__Local__62)->SetPropertyValue_InContainer((bpv__MissionText__pf), false, 0));
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__MissionText__pf), true, 0));
	bpv__NewVar_0__pf = false;
	bpv__OwningxPlayer__pfT = nullptr;
	PrimaryActorTick.bCanEverTick = true;
	auto& __Local__64 = (*(AccessPrivateProperty<EActorUpdateOverlapsMethod >((this), AActor::__PPO__DefaultUpdateOverlapsMethodDuringLevelStreaming() )));
	__Local__64 = EActorUpdateOverlapsMethod::OnlyUpdateMovable;
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_HorsemenHUD_C__pf760233656::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__SpawnLocation__pf)
	{
		bpv__SpawnLocation__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Overlay_Loc__pf)
	{
		bpv__Overlay_Loc__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__HUD_Overlay__pf)
	{
		bpv__HUD_Overlay__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Objective_Loc__pf)
	{
		bpv__Objective_Loc__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__ObjectivePointer__pf)
	{
		bpv__ObjectivePointer__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__MissionText_Loc__pf)
	{
		bpv__MissionText_Loc__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__MissionText__pf)
	{
		bpv__MissionText__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_HorsemenHUD_C__pf760233656::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UHUD_Overlay_C__pf1982152804::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UObjectivePointer_C__pf2435026734::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UWidg_MissionText_C__pf1982152804::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_HorsemenHUD_C__pf760233656::bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_0(int32 bpp__EntryPoint__pf)
{
	UUserWidget* bpfv__CallFunc_GetWidget_ReturnValue_2__pf{};
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__ObjectivePointer__pf))
	{
		bpfv__CallFunc_GetWidget_ReturnValue_2__pf = bpv__ObjectivePointer__pf->GetWidget();
	}
	b0l__K2Node_DynamicCast_AsObjective_Pointer_3__pf = Cast<UObjectivePointer_C__pf2435026734>(bpfv__CallFunc_GetWidget_ReturnValue_2__pf);
	b0l__K2Node_DynamicCast_bSuccess_5__pf = (b0l__K2Node_DynamicCast_AsObjective_Pointer_3__pf != nullptr);;
	if(::IsValid(b0l__K2Node_DynamicCast_AsObjective_Pointer_3__pf))
	{
		b0l__K2Node_DynamicCast_AsObjective_Pointer_3__pf->bpf__UpdateLocation__pf(b0l__K2Node_Event_NewLocation__pf);
	}
	return; //KCST_EndOfThread
}
void ABP_HorsemenHUD_C__pf760233656::bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 4:
			{
				if(::IsValid(bpv__MissionText__pf))
				{
					bpv__MissionText__pf->USceneComponent::SetVisibility(false, false);
				}
				__CurrentState = -1;
				break;
			}
		...
		case 27:
			{
				if(::IsValid(bpv__MissionText__pf))
				{
					bpv__MissionText__pf->USceneComponent::SetVisibility(true, false);
				}
			}
		case 28:
			{
				if(::IsValid(bpv__MissionText__pf))
				{
					bpfv__CallFunc_GetWidget_ReturnValue_1__pf = bpv__MissionText__pf->GetWidget();
				}
				b0l__K2Node_DynamicCast_AsWidg_Mission_Text__pf = Cast<UWidg_MissionText_C__pf1982152804>(bpfv__CallFunc_GetWidget_ReturnValue_1__pf);
				b0l__K2Node_DynamicCast_bSuccess_4__pf = (b0l__K2Node_DynamicCast_AsWidg_Mission_Text__pf != nullptr);;
				if(::IsValid(b0l__K2Node_DynamicCast_AsWidg_Mission_Text__pf))
				{
					b0l__K2Node_DynamicCast_AsWidg_Mission_Text__pf->bpv__MissionDetails__pf = b0l__K2Node_Event_ObjectiveDetails__pf;
				}
			}
		case 29:
			{
				UKismetSystemLibrary::Delay(this, 10.000000, FLatentActionInfo(3, 484314924, TEXT("ExecuteUbergraph_BP_HorsemenHUD_1"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void ABP_HorsemenHUD_C__pf760233656::bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 31);
	return; //KCST_EndOfThread
}
void ABP_HorsemenHUD_C__pf760233656::bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 30);
	return; //KCST_EndOfThread
}
void ABP_HorsemenHUD_C__pf760233656::bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 15:
			{
				if(::IsValid(bpv__ObjectivePointer__pf))
				{
					bpfv__CallFunc_GetWidget_ReturnValue__pf = bpv__ObjectivePointer__pf->GetWidget();
				}
				b0l__K2Node_DynamicCast_AsObjective_Pointer__pf = Cast<UObjectivePointer_C__pf2435026734>(bpfv__CallFunc_GetWidget_ReturnValue__pf);
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsObjective_Pointer__pf != nullptr);;
		...
		case 17:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsObjective_Pointer__pf)) ? (b0l__K2Node_DynamicCast_AsObjective_Pointer__pf->bpv__CanAnimatex__pfzy) : (__Local__66)))
				{
					__CurrentState = 22;
					break;
				}
		...
		case 18:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("Can Animate is True")), true, true, FLinearColor(0.031698,1.000000,0.351235,1.000000), 2.000000);
				__CurrentState = -1;
				break;
			}
		case 19:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsObjective_Pointer__pf)) ? (b0l__K2Node_DynamicCast_AsObjective_Pointer__pf->bpv__CanAnimatex__pfzy) : (__Local__67)))
				{
					__CurrentState = -1;
					break;
				}
		...
		case 20:
			{
				...
				b0l__K2Node_DynamicCast_AsObjective_Pointer_2__pf = Cast<UObjectivePointer_C__pf2435026734>(bpfv__CallFunc_GetWidget_ReturnValue__pf);
				b0l__K2Node_DynamicCast_bSuccess_3__pf = (b0l__K2Node_DynamicCast_AsObjective_Pointer_2__pf != nullptr);;
		...
		case 21:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsObjective_Pointer_2__pf))
				{
					b0l__K2Node_DynamicCast_AsObjective_Pointer_2__pf->bpv__CanAnimatex__pfzy = false;
				}
				__CurrentState = -1;
				break;
			}
		case 22:
			{
				...
				b0l__K2Node_DynamicCast_AsObjective_Pointer_1__pf = Cast<UObjectivePointer_C__pf2435026734>(bpfv__CallFunc_GetWidget_ReturnValue__pf);
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsObjective_Pointer_1__pf != nullptr);;
		...
		case 23:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsObjective_Pointer_1__pf))
				{
					b0l__K2Node_DynamicCast_AsObjective_Pointer_1__pf->bpv__CanAnimatex__pfzy = true;
				}
				__CurrentState = -1;
				break;
			}
		...
		case 25:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("I am Being called")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = 15;
				break;
			}
		default:
...
void ABP_HorsemenHUD_C__pf760233656::bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_5(int32 bpp__EntryPoint__pf)
{
	...
	ADamageIndicator_Actor_C__pf760233656* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	...
	bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, ADamageIndicator_Actor_C__pf760233656::StaticClass(), bpfv__CallFunc_MakeTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, bpv__OwningxPlayer__pfT);
	bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(FVector(0.000000,0.000000,0.000000), FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000));
	bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<ADamageIndicator_Actor_C__pf760233656>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_MakeTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
	if(::IsValid(bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf))
	{
		bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf->bpv__Cur_Direction__pf = b0l__K2Node_Event_Source__pf;
	}
	if(::IsValid(bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf))
	{
		bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf->AActor::K2_AttachToComponent(bpv__SpawnLocation__pf, FName(TEXT("None")), EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, false);
	}
	return; //KCST_EndOfThread
}
void ABP_HorsemenHUD_C__pf760233656::bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_6(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 14);
	return; //KCST_EndOfThread
}
void ABP_HorsemenHUD_C__pf760233656::bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_7(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_AsBP_Player_Character_Base__pf = Cast<ABP_PlayerCharacter_Base_C__pf1490413170>(bpfv__CallFunc_GetPlayerCharacter_ReturnValue__pf);
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsBP_Player_Character_Base__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	bpv__OwningxPlayer__pfT = b0l__K2Node_DynamicCast_AsBP_Player_Character_Base__pf;
	return; //KCST_EndOfThread
}
void ABP_HorsemenHUD_C__pf760233656::bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_8(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 10);
	return; //KCST_EndOfThread
}
void ABP_HorsemenHUD_C__pf760233656::bpf__UpdateObjectiveLoc__pf(FVector bpp__NewLocation__pf)
{
	b0l__K2Node_Event_NewLocation__pf = bpp__NewLocation__pf;
	bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_0(1);
}
void ABP_HorsemenHUD_C__pf760233656::bpf__UpdateMission__pf(const FText& bpp__ObjectiveDetails__pf__const)
{
	typedef FText  T__Local__68;
	T__Local__68& bpp__ObjectiveDetails__pf = *const_cast<T__Local__68 *>(&bpp__ObjectiveDetails__pf__const);
	b0l__K2Node_Event_ObjectiveDetails__pf = bpp__ObjectiveDetails__pf;
	bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_1(26);
}
void ABP_HorsemenHUD_C__pf760233656::bpf__ToggleObjetiveBool__pf(bool bpp__Objectivex__pfzy)
{
	b0l__K2Node_Event_Objective___pf = bpp__Objectivex__pfzy;
	bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_4(24);
}
void ABP_HorsemenHUD_C__pf760233656::bpf__Player_Was_Hit__pf(bool bpp__CurrentlyHit__pf)
{
	b0l__K2Node_Event_CurrentlyHit__pf = bpp__CurrentlyHit__pf;
	bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_8(10);
}
void ABP_HorsemenHUD_C__pf760233656::bpf__Damage_Source__pf(FVector bpp__Source__pf)
{
	b0l__K2Node_Event_Source__pf = bpp__Source__pf;
	bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_5(5);
}
void ABP_HorsemenHUD_C__pf760233656::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_7(13);
}
void ABP_HorsemenHUD_C__pf760233656::bpf__SpawnxDamagexWidget__pfTT(FVector bpp__Direction__pf)
{
	b0l__K2Node_CustomEvent_Direction__pf = bpp__Direction__pf;
	bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_6(14);
}
void ABP_HorsemenHUD_C__pf760233656::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_2(31);
}
void ABP_HorsemenHUD_C__pf760233656::bpf__RespawningxTrace__pfT(FVector bpp__Direction__pf)
{
	b0l__K2Node_CustomEvent_Direction_1__pf = bpp__Direction__pf;
	bpf__ExecuteUbergraph_BP_HorsemenHUD__pf_3(30);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_HorsemenHUD_C__pf760233656::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_HorsemenHUD_C__pf760233656::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{160, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/Widgets/HUD_Overlay.HUD_Overlay_C 
		{161, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/Widgets/Objective_Display/ObjectivePointer.ObjectivePointer_C 
		{162, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/Widgets/Widg_MissionText.Widg_MissionText_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_HorsemenHUD_C__pf760233656
{
	FRegisterHelper__ABP_HorsemenHUD_C__pf760233656()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/Widgets/Damage_Display/BP_HorsemenHUD"), &ABP_HorsemenHUD_C__pf760233656::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_HorsemenHUD_C__pf760233656 Instance;
};
FRegisterHelper__ABP_HorsemenHUD_C__pf760233656 FRegisterHelper__ABP_HorsemenHUD_C__pf760233656::Instance;
