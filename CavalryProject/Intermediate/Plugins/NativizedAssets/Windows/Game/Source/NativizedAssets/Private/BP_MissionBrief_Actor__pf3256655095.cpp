...
ABP_MissionBrief_Actor_C__pf3256655095::ABP_MissionBrief_Actor_C__pf3256655095(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__Menu_Origin__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Menu_Origin"));
	bpv__Start_Button_Loc__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Start_Button_Loc"));
	bpv__StartButton_Widget__pf = CreateDefaultSubobject<UWidgetComponent>(TEXT("StartButton_Widget"));
	...
	bpv__Start_Button_Loc__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Start_Button_Loc__pf->AttachToComponent(bpv__Menu_Origin__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<FVector >((bpv__Start_Button_Loc__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__2 = FVector(190.000000, 0.000045, 170.000000);
	auto& __Local__3 = (*(AccessPrivateProperty<FRotator >((bpv__Start_Button_Loc__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__3 = FRotator(0.000000, -179.999969, 0.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Start_Button_Loc__pf), true, 0));
	bpv__StartButton_Widget__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__StartButton_Widget__pf->AttachToComponent(bpv__Start_Button_Loc__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__4 = (*(AccessPrivateProperty<TSubclassOf<UUserWidget>  >((bpv__StartButton_Widget__pf), UWidgetComponent::__PPO__WidgetClass() )));
	__Local__4 = UStart_Mission_Breif_C__pf3256655095::StaticClass();
	auto& __Local__5 = (*(AccessPrivateProperty<FIntPoint >((bpv__StartButton_Widget__pf), UWidgetComponent::__PPO__DrawSize() )));
	__Local__5.X = 400;
	__Local__5.Y = 100;
	auto& __Local__6 = (*(AccessPrivateProperty<FVector >((bpv__StartButton_Widget__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__6 = FVector(0.600000, 0.600000, 0.600000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__StartButton_Widget__pf), true, 0));
...
void ABP_MissionBrief_Actor_C__pf3256655095::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__Start_Button_Loc__pf)
	{
		bpv__Start_Button_Loc__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__StartButton_Widget__pf)
	{
		bpv__StartButton_Widget__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_MissionBrief_Actor_C__pf3256655095::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UStart_Mission_Breif_C__pf3256655095::StaticClass());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_MissionBrief_Actor_C__pf3256655095::bpf__ExecuteUbergraph_BP_MissionBrief_Actor__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void ABP_MissionBrief_Actor_C__pf3256655095::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BP_MissionBrief_Actor__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_MissionBrief_Actor_C__pf3256655095::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_MissionBrief_Actor_C__pf3256655095::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{208, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/Main_Menu/Start_Mission_Breif.Start_Mission_Breif_C 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_MissionBrief_Actor_C__pf3256655095
{
	FRegisterHelper__ABP_MissionBrief_Actor_C__pf3256655095()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/Main_Menu/BP_MissionBrief_Actor"), &ABP_MissionBrief_Actor_C__pf3256655095::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_MissionBrief_Actor_C__pf3256655095 Instance;
};
FRegisterHelper__ABP_MissionBrief_Actor_C__pf3256655095 FRegisterHelper__ABP_MissionBrief_Actor_C__pf3256655095::Instance;
