...
ABP_BulletBase_C__pf1418999182::ABP_BulletBase_C__pf1418999182(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__ProjectileMovement__pf = CreateDefaultSubobject<UProjectileMovementComponent>(TEXT("ProjectileMovement"));
	bpv__Bullet_SM__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Bullet_SM"));
	bpv__Arrow__pf = CreateDefaultSubobject<UArrowComponent>(TEXT("Arrow"));
	RootComponent = bpv__Bullet_SM__pf;
	...
	bpv__ProjectileMovement__pf->MaxSpeed = 1000.000000f;
	...
	bpv__Bullet_SM__pf->CreationMethod = EComponentCreationMethod::Native;
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Bullet_SM__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_BulletBase_C__pf1418999182::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Bullet_SM__pf->BodyInstance.bSimulatePhysics = true;
	bpv__Bullet_SM__pf->SetCollisionProfileName(FName(TEXT("PhysicsActor")));
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Bullet_SM__pf), true, 0));
	bpv__Arrow__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Arrow__pf->AttachToComponent(bpv__Bullet_SM__pf, FAttachmentTransformRules::KeepRelativeTransform );
...
void ABP_BulletBase_C__pf1418999182::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_BulletBase_C__pf1418999182::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_BulletBase_C__pf1418999182::bpf__ExecuteUbergraph_BP_BulletBase__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 4:
			{
				UKismetSystemLibrary::Delay(this, 5.000000, FLatentActionInfo(2, 1163290776, TEXT("ExecuteUbergraph_BP_BulletBase_0"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void ABP_BulletBase_C__pf1418999182::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BP_BulletBase__pf_0(3);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_BulletBase_C__pf1418999182::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_BulletBase_C__pf1418999182::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{107, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.ProjectileMovementComponent 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_BulletBase_C__pf1418999182
{
	FRegisterHelper__ABP_BulletBase_C__pf1418999182()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Weapons/BP_BulletBase"), &ABP_BulletBase_C__pf1418999182::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_BulletBase_C__pf1418999182 Instance;
};
FRegisterHelper__ABP_BulletBase_C__pf1418999182 FRegisterHelper__ABP_BulletBase_C__pf1418999182::Instance;
