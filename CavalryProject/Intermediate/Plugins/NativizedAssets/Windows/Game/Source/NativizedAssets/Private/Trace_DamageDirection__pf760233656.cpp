...
#include "Trace_DamageDirection__pf760233656.h"
...
ATrace_DamageDirection_C__pf760233656::ATrace_DamageDirection_C__pf760233656(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ATrace_DamageDirection_C__pf760233656::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Direction__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Direction__pf->OverrideMaterials.Reserve(1);
	bpv__Direction__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ATrace_DamageDirection_C__pf760233656::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
...
void ATrace_DamageDirection_C__pf760233656::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ATrace_DamageDirection_C__pf760233656::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ATrace_DamageDirection_C__pf760233656::bpf__ExecuteUbergraph_Trace_DamageDirection__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpv__GetxDamagexDirection__pfTT.Broadcast(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf);
	return; // KCST_GotoReturn
}
void ATrace_DamageDirection_C__pf760233656::bpf__ExecuteUbergraph_Trace_DamageDirection__pf_1(int32 bpp__EntryPoint__pf)
{
...
void ATrace_DamageDirection_C__pf760233656::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_Trace_DamageDirection__pf_0(1);
}
void ATrace_DamageDirection_C__pf760233656::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Trace_DamageDirection__pf_1(5);
}
PRAGMA_DISABLE_OPTIMIZATION
void ATrace_DamageDirection_C__pf760233656::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ATrace_DamageDirection_C__pf760233656::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ATrace_DamageDirection_C__pf760233656
{
	FRegisterHelper__ATrace_DamageDirection_C__pf760233656()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/Widgets/Damage_Display/Trace_DamageDirection"), &ATrace_DamageDirection_C__pf760233656::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ATrace_DamageDirection_C__pf760233656 Instance;
};
FRegisterHelper__ATrace_DamageDirection_C__pf760233656 FRegisterHelper__ATrace_DamageDirection_C__pf760233656::Instance;
