...
ABP_GrabAmmoTrigger_C__pf3324220276::ABP_GrabAmmoTrigger_C__pf3324220276(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Trigger__pf = CreateDefaultSubobject<UBoxComponent>(TEXT("Trigger"));
	RootComponent = bpv__Trigger__pf;
	...
	auto& __Local__0 = (*(AccessPrivateProperty<FVector >((bpv__Trigger__pf), UBoxComponent::__PPO__BoxExtent() )));
	__Local__0 = FVector(12.306825, 5.137029, 6.530495);
	bpv__Trigger__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__1 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__Trigger__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__1 = ECollisionChannel::ECC_GameTraceChannel3;
	auto& __Local__2 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Trigger__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__12.Channel = FName(TEXT("PlayerCollision"));
	...
	(((FBoolProperty*)__Local__13)->SetPropertyValue_InContainer((bpv__Trigger__pf), true, 0));
	bpv__GrabbableObjectSocket__pf->CreationMethod = EComponentCreationMethod::Native;
	(((FBoolProperty*)__Local__13)->SetPropertyValue_InContainer((bpv__GrabbableObjectSocket__pf), false, 0));
	bpv__AmmoToSpawn__pf = E__E_LoadType__pf::NewEnumerator1;
	bpv__LoadTypeCount__pf = 0;
	bpv__SpawnedAmmo__pf = nullptr;
	bpv__canSpawn__pf = false;
	bpv__NumberOfHandsInTrigger__pf = 0;
...
void ABP_GrabAmmoTrigger_C__pf3324220276::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_GrabAmmoTrigger_C__pf3324220276::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__17 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"), (EObjectFlags)0x00000000);
	InDynamicClass->DynamicBindingObjects.Add(__Local__17);
	...
	(((FBoolProperty*)__Local__18)->SetPropertyValue_InContainer((__Local__16), false, 0));
	__Local__17->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__17->ComponentDelegateBindings.AddUninitialized(2);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__17->ComponentDelegateBindings.GetData(), 2);
	auto& __Local__20 = __Local__17->ComponentDelegateBindings[0];
	__Local__20.ComponentPropertyName = FName(TEXT("Trigger"));
	__Local__20.DelegatePropertyName = FName(TEXT("OnComponentEndOverlap"));
	__Local__20.FunctionNameToBind = FName(TEXT("BndEvt__BP_GrabAmmoTrigger_Trigger_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
	auto& __Local__21 = __Local__17->ComponentDelegateBindings[1];
	__Local__21.ComponentPropertyName = FName(TEXT("Trigger"));
	__Local__21.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__21.FunctionNameToBind = FName(TEXT("BndEvt__BP_GrabAmmoTrigger_Trigger_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_GrabAmmoTrigger_C__pf3324220276::bpf__ExecuteUbergraph_BP_GrabAmmoTrigger__pf_0(int32 bpp__EntryPoint__pf)
{
	int32 bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf{};
	UGrabbableObjectSocket_C__pf2132744816* bpfv__CallFunc_GetComponentByClass_ReturnValue__pf{};
	UGrabbableObjectSocket_C__pf2132744816* bpfv__CallFunc_GetComponentByClass_ReturnValue_1__pf{};
	UGrabbableObjectSocket_C__pf2132744816* bpfv__CallFunc_GetComponentByClass_ReturnValue_2__pf{};
	...
	ABP_AmmoBase_C__pf1418999182* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	AActor* bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf{};
	ABP_AmmoBase_C__pf1418999182* bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf{};
	...
	ABP_AmmoBase_C__pf1418999182* bpfv__CallFunc_FinishSpawningActor_ReturnValue_2__pf{};
	ABP_AmmoBase_C__pf1418999182* bpfv__CallFunc_FinishSpawningActor_ReturnValue_3__pf{};
	AActor* bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_4__pf{};
	ABP_AmmoBase_C__pf1418999182* bpfv__CallFunc_FinishSpawningActor_ReturnValue_4__pf{};
	UGrabbableObjectSocket_C__pf2132744816* bpfv__CallFunc_GetComponentByClass_ReturnValue_3__pf{};
	int32 bpfv__CallFunc_Subtract_IntInt_ReturnValue_3__pf{};
	UGrabbableObjectSocket_C__pf2132744816* bpfv__CallFunc_GetComponentByClass_ReturnValue_4__pf{};
	...
	do
	{
		...
		case 10:
			{
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoToSpawn__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator0));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 11;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoToSpawn__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator2));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 17;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoToSpawn__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator3));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 23;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoToSpawn__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator4));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 29;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoToSpawn__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator1));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 35;
					break;
		...
		case 11:
			{
				...
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_4__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, CastChecked<UClass>(CastChecked<UDynamicClass>(ABP_GrabAmmoTrigger_C__pf3324220276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed), b0l__CallFunc_GetTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
			}
		case 12:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_FinishSpawningActor_ReturnValue_4__pf = CastChecked<ABP_AmmoBase_C__pf1418999182>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_4__pf, b0l__CallFunc_GetTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 13:
			{
				bpv__SpawnedAmmo__pf = bpfv__CallFunc_FinishSpawningActor_ReturnValue_4__pf;
			}
		case 14:
			{
				bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(bpv__LoadTypeCount__pf, 1);
				b0l__Temp_int_Variable_1__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf;
			}
		case 15:
			{
				bpv__LoadTypeCount__pf = b0l__Temp_int_Variable_1__pf;
			}
		case 16:
			{
				if(::IsValid(bpv__SpawnedAmmo__pf))
				{
					bpfv__CallFunc_GetComponentByClass_ReturnValue_1__pf = CastChecked<UGrabbableObjectSocket_C__pf2132744816>(bpv__SpawnedAmmo__pf->AActor::GetComponentByClass(UGrabbableObjectSocket_C__pf2132744816::StaticClass()), ECastCheckedType::NullAllowed);
				}
				if(::IsValid(bpfv__CallFunc_GetComponentByClass_ReturnValue_1__pf))
				{
					UStaticMeshComponent*  __Local__22 = ((UStaticMeshComponent*)nullptr);
					bpfv__CallFunc_GetComponentByClass_ReturnValue_1__pf->bpf__Grab__pf(((::IsValid(bpfv__CallFunc_FinishSpawningActor_ReturnValue_4__pf)) ? (bpfv__CallFunc_FinishSpawningActor_ReturnValue_4__pf->bpv__Ammo_SM__pf) : (__Local__22)), bpfv__CallFunc_FinishSpawningActor_ReturnValue_4__pf, b0l__K2Node_Event_HandSocket__pf, b0l__K2Node_Event_AttachToMe__pf);
				}
				__CurrentState = -1;
				break;
			}
		case 17:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_3__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, CastChecked<UClass>(CastChecked<UDynamicClass>(ABP_GrabAmmoTrigger_C__pf3324220276::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed), b0l__CallFunc_GetTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
			}
		case 18:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_FinishSpawningActor_ReturnValue_3__pf = CastChecked<ABP_AmmoBase_C__pf1418999182>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_3__pf, b0l__CallFunc_GetTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 19:
			{
				bpv__SpawnedAmmo__pf = bpfv__CallFunc_FinishSpawningActor_ReturnValue_3__pf;
			}
		case 20:
			{
				bpfv__CallFunc_Subtract_IntInt_ReturnValue_5__pf = UKismetMathLibrary::Subtract_IntInt(bpv__LoadTypeCount__pf, 1);
				b0l__Temp_int_Variable_4__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue_5__pf;
			}
		case 21:
			{
				bpv__LoadTypeCount__pf = b0l__Temp_int_Variable_4__pf;
			}
		case 22:
			{
				if(::IsValid(bpv__SpawnedAmmo__pf))
				{
					bpfv__CallFunc_GetComponentByClass_ReturnValue__pf = CastChecked<UGrabbableObjectSocket_C__pf2132744816>(bpv__SpawnedAmmo__pf->AActor::GetComponentByClass(UGrabbableObjectSocket_C__pf2132744816::StaticClass()), ECastCheckedType::NullAllowed);
				}
				if(::IsValid(bpfv__CallFunc_GetComponentByClass_ReturnValue__pf))
				{
					UStaticMeshComponent*  __Local__23 = ((UStaticMeshComponent*)nullptr);
					bpfv__CallFunc_GetComponentByClass_ReturnValue__pf->bpf__Grab__pf(((::IsValid(bpfv__CallFunc_FinishSpawningActor_ReturnValue_3__pf)) ? (bpfv__CallFunc_FinishSpawningActor_ReturnValue_3__pf->bpv__Ammo_SM__pf) : (__Local__23)), bpfv__CallFunc_FinishSpawningActor_ReturnValue_3__pf, b0l__K2Node_Event_HandSocket__pf, b0l__K2Node_Event_AttachToMe__pf);
				}
				__CurrentState = -1;
				break;
			}
		case 23:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_2__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, CastChecked<UClass>(CastChecked<UDynamicClass>(ABP_GrabAmmoTrigger_C__pf3324220276::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), b0l__CallFunc_GetTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
			}
		case 24:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_FinishSpawningActor_ReturnValue_2__pf = CastChecked<ABP_AmmoBase_C__pf1418999182>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_2__pf, b0l__CallFunc_GetTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 25:
			{
				bpv__SpawnedAmmo__pf = bpfv__CallFunc_FinishSpawningActor_ReturnValue_2__pf;
			}
		case 26:
			{
				bpfv__CallFunc_Subtract_IntInt_ReturnValue_4__pf = UKismetMathLibrary::Subtract_IntInt(bpv__LoadTypeCount__pf, 1);
				b0l__Temp_int_Variable_6__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue_4__pf;
			}
		case 27:
			{
				bpv__LoadTypeCount__pf = b0l__Temp_int_Variable_6__pf;
			}
		case 28:
			{
				if(::IsValid(bpv__SpawnedAmmo__pf))
				{
					bpfv__CallFunc_GetComponentByClass_ReturnValue_2__pf = CastChecked<UGrabbableObjectSocket_C__pf2132744816>(bpv__SpawnedAmmo__pf->AActor::GetComponentByClass(UGrabbableObjectSocket_C__pf2132744816::StaticClass()), ECastCheckedType::NullAllowed);
				}
				if(::IsValid(bpfv__CallFunc_GetComponentByClass_ReturnValue_2__pf))
				{
					UStaticMeshComponent*  __Local__24 = ((UStaticMeshComponent*)nullptr);
					bpfv__CallFunc_GetComponentByClass_ReturnValue_2__pf->bpf__Grab__pf(((::IsValid(bpfv__CallFunc_FinishSpawningActor_ReturnValue_2__pf)) ? (bpfv__CallFunc_FinishSpawningActor_ReturnValue_2__pf->bpv__Ammo_SM__pf) : (__Local__24)), bpfv__CallFunc_FinishSpawningActor_ReturnValue_2__pf, b0l__K2Node_Event_HandSocket__pf, b0l__K2Node_Event_AttachToMe__pf);
				}
				__CurrentState = -1;
				break;
			}
		case 29:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, CastChecked<UClass>(CastChecked<UDynamicClass>(ABP_GrabAmmoTrigger_C__pf3324220276::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), b0l__CallFunc_GetTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
			}
		case 30:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf = CastChecked<ABP_AmmoBase_C__pf1418999182>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf, b0l__CallFunc_GetTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 31:
			{
				bpv__SpawnedAmmo__pf = bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf;
			}
		case 32:
			{
				bpfv__CallFunc_Subtract_IntInt_ReturnValue_3__pf = UKismetMathLibrary::Subtract_IntInt(bpv__LoadTypeCount__pf, 1);
				b0l__Temp_int_Variable_3__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue_3__pf;
			}
		case 33:
			{
				bpv__LoadTypeCount__pf = b0l__Temp_int_Variable_3__pf;
			}
		case 34:
			{
				if(::IsValid(bpv__SpawnedAmmo__pf))
				{
					bpfv__CallFunc_GetComponentByClass_ReturnValue_3__pf = CastChecked<UGrabbableObjectSocket_C__pf2132744816>(bpv__SpawnedAmmo__pf->AActor::GetComponentByClass(UGrabbableObjectSocket_C__pf2132744816::StaticClass()), ECastCheckedType::NullAllowed);
				}
				if(::IsValid(bpfv__CallFunc_GetComponentByClass_ReturnValue_3__pf))
				{
					...
					bpfv__CallFunc_GetComponentByClass_ReturnValue_3__pf->bpf__Grab__pf(((::IsValid(bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf)) ? (bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf->bpv__Ammo_SM__pf) : (__Local__25)), bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf, b0l__K2Node_Event_HandSocket__pf, b0l__K2Node_Event_AttachToMe__pf);
				}
				__CurrentState = -1;
				break;
			}
		case 35:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, CastChecked<UClass>(CastChecked<UDynamicClass>(ABP_GrabAmmoTrigger_C__pf3324220276::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed), b0l__CallFunc_GetTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
			}
		case 36:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<ABP_AmmoBase_C__pf1418999182>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, b0l__CallFunc_GetTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 37:
			{
				bpv__SpawnedAmmo__pf = bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf;
			}
		case 38:
			{
				bpfv__CallFunc_Subtract_IntInt_ReturnValue_1__pf = UKismetMathLibrary::Subtract_IntInt(bpv__LoadTypeCount__pf, 1);
				b0l__Temp_int_Variable_5__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue_1__pf;
			}
		case 39:
			{
				bpv__LoadTypeCount__pf = b0l__Temp_int_Variable_5__pf;
			}
		case 40:
			{
				if(::IsValid(bpv__SpawnedAmmo__pf))
				{
					bpfv__CallFunc_GetComponentByClass_ReturnValue_4__pf = CastChecked<UGrabbableObjectSocket_C__pf2132744816>(bpv__SpawnedAmmo__pf->AActor::GetComponentByClass(UGrabbableObjectSocket_C__pf2132744816::StaticClass()), ECastCheckedType::NullAllowed);
				}
				if(::IsValid(bpfv__CallFunc_GetComponentByClass_ReturnValue_4__pf))
				{
					UStaticMeshComponent*  __Local__26 = ((UStaticMeshComponent*)nullptr);
					bpfv__CallFunc_GetComponentByClass_ReturnValue_4__pf->bpf__Grab__pf(((::IsValid(bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf)) ? (bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf->bpv__Ammo_SM__pf) : (__Local__26)), bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf, b0l__K2Node_Event_HandSocket__pf, b0l__K2Node_Event_AttachToMe__pf);
				}
				__CurrentState = -1;
				break;
			}
...
void ABP_GrabAmmoTrigger_C__pf3324220276::bpf__ExecuteUbergraph_BP_GrabAmmoTrigger__pf_1(int32 bpp__EntryPoint__pf)
{
	int32 __CurrentState = bpp__EntryPoint__pf;
	do
	{
		...
		case 42:
			{
				b0l__K2Node_SwitchEnum_CmpSuccess_1__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoToSpawn__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator0));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess_1__pf)
				{
					__CurrentState = 47;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess_1__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoToSpawn__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator2));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess_1__pf)
				{
					__CurrentState = 46;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess_1__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoToSpawn__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator3));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess_1__pf)
				{
					__CurrentState = 45;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess_1__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoToSpawn__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator4));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess_1__pf)
				{
					__CurrentState = 44;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess_1__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoToSpawn__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator1));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess_1__pf)
				{
					__CurrentState = 43;
					break;
		...
		case 43:
			{
				bpv__LoadTypeCount__pf = 20;
				__CurrentState = -1;
				break;
			}
		case 44:
			{
				bpv__LoadTypeCount__pf = 4;
				__CurrentState = -1;
				break;
			}
		case 45:
...
void ABP_GrabAmmoTrigger_C__pf3324220276::bpf__ExecuteUbergraph_BP_GrabAmmoTrigger__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 49:
			{
				bpfv__CallFunc_Subtract_IntInt_ReturnValue_2__pf = UKismetMathLibrary::Subtract_IntInt(bpv__NumberOfHandsInTrigger__pf, 1);
				b0l__Temp_int_Variable_2__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue_2__pf;
			}
		case 50:
			{
				bpv__NumberOfHandsInTrigger__pf = b0l__Temp_int_Variable_2__pf;
			}
		case 51:
			{
				bpfv__CallFunc_Greater_IntInt_ReturnValue__pf = UKismetMathLibrary::Greater_IntInt(bpv__NumberOfHandsInTrigger__pf, 0);
...
void ABP_GrabAmmoTrigger_C__pf3324220276::bpf__ExecuteUbergraph_BP_GrabAmmoTrigger__pf_3(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf{};
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 2);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf, ABP_MotionController_C__pf563933975::StaticClass());
	if (!bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	UKismetSystemLibrary::PrintString(this, FString(TEXT("[GrabAmmoTrigger] Owner hand is in Ammo Trigger")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	bpv__canSpawn__pf = true;
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__NumberOfHandsInTrigger__pf, 1);
	b0l__Temp_int_Variable__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
	bpv__NumberOfHandsInTrigger__pf = b0l__Temp_int_Variable__pf;
	return; // KCST_GotoReturn
}
void ABP_GrabAmmoTrigger_C__pf3324220276::bpf__ExecuteUbergraph_BP_GrabAmmoTrigger__pf_4(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void ABP_GrabAmmoTrigger_C__pf3324220276::bpf__BndEvt__BP_GrabAmmoTrigger_Trigger_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
	...
	bpf__ExecuteUbergraph_BP_GrabAmmoTrigger__pf_2(48);
}
void ABP_GrabAmmoTrigger_C__pf3324220276::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BP_GrabAmmoTrigger__pf_1(41);
}
void ABP_GrabAmmoTrigger_C__pf3324220276::bpf__Grab__pf(FName bpp__HandSocket__pf, USceneComponent* bpp__AttachToMe__pf, AActor* bpp__Actor__pf)
{
	...
	bpf__ExecuteUbergraph_BP_GrabAmmoTrigger__pf_0(8);
}
void ABP_GrabAmmoTrigger_C__pf3324220276::bpf__BndEvt__BP_GrabAmmoTrigger_Trigger_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BP_GrabAmmoTrigger__pf_3(2);
}
void ABP_GrabAmmoTrigger_C__pf3324220276::bpf__Release__pf(EControllerHand bpp__NewParam__pf)
{
	b0l__K2Node_Event_NewParam__pf = bpp__NewParam__pf;
	bpf__ExecuteUbergraph_BP_GrabAmmoTrigger__pf_4(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_GrabAmmoTrigger_C__pf3324220276::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_GrabAmmoTrigger_C__pf3324220276::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_GrabAmmoTrigger_C__pf3324220276
{
	FRegisterHelper__ABP_GrabAmmoTrigger_C__pf3324220276()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Characters/Gear/BP_GrabAmmoTrigger"), &ABP_GrabAmmoTrigger_C__pf3324220276::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_GrabAmmoTrigger_C__pf3324220276 Instance;
};
FRegisterHelper__ABP_GrabAmmoTrigger_C__pf3324220276 FRegisterHelper__ABP_GrabAmmoTrigger_C__pf3324220276::Instance;
