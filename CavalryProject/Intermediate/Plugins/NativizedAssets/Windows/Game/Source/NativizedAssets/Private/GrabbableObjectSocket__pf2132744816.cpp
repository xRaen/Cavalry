...
UGrabbableObjectSocket_C__pf2132744816::UGrabbableObjectSocket_C__pf2132744816(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__StaticMeshComponent__pf = nullptr;
	bpv__RootActor__pf = nullptr;
	bpv__ComponentActive__pf = true;
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UGrabbableObjectSocket_C__pf2132744816::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UGrabbableObjectSocket_C__pf2132744816::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UGrabbableObjectSocket_C__pf2132744816::bpf__ExecuteUbergraph_GrabbableObjectSocket__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	if (!bpv__ComponentActive__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	bpv__StaticMeshComponent__pf = b0l__K2Node_CustomEvent_StaticMeshComponent__pf;
	bpv__RootActor__pf = b0l__K2Node_CustomEvent_RootActor__pf;
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__StaticMeshComponent__pf))
	{
		bpv__StaticMeshComponent__pf->SetSimulatePhysics(false);
	}
	if(::IsValid(bpv__RootActor__pf))
	{
		bpfv__CallFunc_K2_GetRootComponent_ReturnValue__pf = bpv__RootActor__pf->AActor::K2_GetRootComponent();
	}
	if(::IsValid(bpfv__CallFunc_K2_GetRootComponent_ReturnValue__pf))
	{
		bpfv__CallFunc_K2_AttachToComponent_ReturnValue__pf = bpfv__CallFunc_K2_GetRootComponent_ReturnValue__pf->USceneComponent::K2_AttachToComponent(b0l__K2Node_CustomEvent_AttachTo__pf, b0l__K2Node_CustomEvent_SocketName__pf, EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, false);
	}
	if(::IsValid(b0l__K2Node_CustomEvent_AttachTo__pf))
	{
		bpfv__CallFunc_GetOwner_ReturnValue__pf = b0l__K2Node_CustomEvent_AttachTo__pf->UActorComponent::GetOwner();
	}
	b0l__K2Node_DynamicCast_AsBP_Motion_Controller__pf = Cast<ABP_MotionController_C__pf563933975>(bpfv__CallFunc_GetOwner_ReturnValue__pf);
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsBP_Motion_Controller__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	EControllerHand  __Local__0 = EControllerHand::Left;
	bpfv__CallFunc_EqualEqual_ByteByte_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ByteByte(static_cast<uint8>(((::IsValid(b0l__K2Node_DynamicCast_AsBP_Motion_Controller__pf)) ? (b0l__K2Node_DynamicCast_AsBP_Motion_Controller__pf->bpv__Hand__pf) : (__Local__0))), static_cast<uint8>(EControllerHand::Right));
	...
	if(::IsValid(bpfv__CallFunc_K2_GetRootComponent_ReturnValue__pf))
	{
		bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf = bpfv__CallFunc_K2_GetRootComponent_ReturnValue__pf->USceneComponent::K2_GetComponentRotation();
	}
	if(::IsValid(bpfv__CallFunc_K2_GetRootComponent_ReturnValue__pf))
	{
	...
	if(::IsValid(bpfv__CallFunc_K2_GetRootComponent_ReturnValue__pf))
	{
		bpfv__CallFunc_K2_GetRootComponent_ReturnValue__pf->USceneComponent::K2_SetWorldTransform(bpfv__CallFunc_MakeTransform_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetWorldTransform_SweepHitResult__pf, false);
	}
	if(::IsValid(bpv__RootActor__pf))
	{
		bpfv__CallFunc_K2_GetRootComponent_ReturnValue__pf = bpv__RootActor__pf->AActor::K2_GetRootComponent();
	...
	if(::IsValid(bpfv__CallFunc_K2_GetRootComponent_ReturnValue__pf))
	{
		bpfv__CallFunc_K2_GetRootComponent_ReturnValue__pf->USceneComponent::K2_AddRelativeRotation(FRotator(0.000000,0.000000,180.000000), false, /*out*/ b0l__CallFunc_K2_AddRelativeRotation_SweepHitResult__pf, false);
	}
	return; // KCST_GotoReturn
}
void UGrabbableObjectSocket_C__pf2132744816::bpf__ExecuteUbergraph_GrabbableObjectSocket__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	if(::IsValid(bpv__RootActor__pf))
	{
		bpv__RootActor__pf->AActor::K2_DetachFromActor(EDetachmentRule::KeepWorld, EDetachmentRule::KeepWorld, EDetachmentRule::KeepWorld);
	}
	return; // KCST_GotoReturn
}
void UGrabbableObjectSocket_C__pf2132744816::bpf__Release__pf()
{
	bpf__ExecuteUbergraph_GrabbableObjectSocket__pf_1(13);
}
void UGrabbableObjectSocket_C__pf2132744816::bpf__Grab__pf(UMeshComponent* bpp__StaticMeshComponent__pf, AActor* bpp__RootActor__pf, FName bpp__SocketName__pf, USceneComponent* bpp__AttachTo__pf)
{
	b0l__K2Node_CustomEvent_StaticMeshComponent__pf = bpp__StaticMeshComponent__pf;
	b0l__K2Node_CustomEvent_RootActor__pf = bpp__RootActor__pf;
	b0l__K2Node_CustomEvent_SocketName__pf = bpp__SocketName__pf;
	b0l__K2Node_CustomEvent_AttachTo__pf = bpp__AttachTo__pf;
	bpf__ExecuteUbergraph_GrabbableObjectSocket__pf_0(12);
}
PRAGMA_DISABLE_OPTIMIZATION
void UGrabbableObjectSocket_C__pf2132744816::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UGrabbableObjectSocket_C__pf2132744816::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{56, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.ActorComponent 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UGrabbableObjectSocket_C__pf2132744816
{
	FRegisterHelper__UGrabbableObjectSocket_C__pf2132744816()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/GrabbableObjectSocket"), &UGrabbableObjectSocket_C__pf2132744816::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UGrabbableObjectSocket_C__pf2132744816 Instance;
};
FRegisterHelper__UGrabbableObjectSocket_C__pf2132744816 FRegisterHelper__UGrabbableObjectSocket_C__pf2132744816::Instance;
