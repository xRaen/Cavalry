...
#include "AmmoDisplay__pf3627927311.h"
...
ABP_AmmoBase_C__pf1418999182::ABP_AmmoBase_C__pf1418999182(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Ammo_SM__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Ammo_SM"));
	bpv__MagnetCollision__pf = CreateDefaultSubobject<UBoxComponent>(TEXT("MagnetCollision"));
	bpv__AmmoWidget_SpawnLoc__pf = CreateDefaultSubobject<UArrowComponent>(TEXT("AmmoWidget_SpawnLoc"));
	RootComponent = bpv__Ammo_SM__pf;
	bpv__GrabbableObjectSocket__pf = CreateDefaultSubobject<UGrabbableObjectSocket_C__pf2132744816>(TEXT("GrabbableObjectSocket"));
	bpv__Ammo_SM__pf->CreationMethod = EComponentCreationMethod::Native;
	auto& __Local__0 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Ammo_SM__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_AmmoBase_C__pf1418999182::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__1 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__Ammo_SM__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__1 = ECollisionChannel::ECC_GameTraceChannel2;
	auto& __Local__2 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Ammo_SM__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	bpv__Ammo_SM__pf->BodyInstance.bSimulatePhysics = true;
	bpv__Ammo_SM__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	...
	(((FBoolProperty*)__Local__8)->SetPropertyValue_InContainer((bpv__Ammo_SM__pf), true, 0));
	bpv__MagnetCollision__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__MagnetCollision__pf->AttachToComponent(bpv__Ammo_SM__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__10 = (*(AccessPrivateProperty<FVector >((bpv__MagnetCollision__pf), UBoxComponent::__PPO__BoxExtent() )));
	__Local__10 = FVector(1.000000, 1.000000, 1.000000);
	bpv__MagnetCollision__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__11 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__MagnetCollision__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__11 = ECollisionChannel::ECC_GameTraceChannel2;
	auto& __Local__12 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__MagnetCollision__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	auto& __Local__21 = __Local__13[7];
	__Local__21.Channel = FName(TEXT("Destructible"));
	__Local__21.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__22 = __Local__13[8];
	__Local__22.Channel = FName(TEXT("Enemy"));
	__Local__22.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__23 = __Local__13[9];
	__Local__23.Channel = FName(TEXT("PlayerCollision"));
	__Local__23.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__24 = __Local__13[10];
	__Local__24.Channel = FName(TEXT("Tool"));
	__Local__24.Response = ECollisionResponse::ECR_Overlap;
	bpv__MagnetCollision__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	(((FBoolProperty*)__Local__8)->SetPropertyValue_InContainer((bpv__MagnetCollision__pf), true, 0));
	bpv__AmmoWidget_SpawnLoc__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__AmmoWidget_SpawnLoc__pf->AttachToComponent(bpv__Ammo_SM__pf, FAttachmentTransformRules::KeepRelativeTransform );
	(((FBoolProperty*)__Local__8)->SetPropertyValue_InContainer((bpv__AmmoWidget_SpawnLoc__pf), false, 0));
	bpv__GrabbableObjectSocket__pf->CreationMethod = EComponentCreationMethod::Native;
	(((FBoolProperty*)__Local__8)->SetPropertyValue_InContainer((bpv__GrabbableObjectSocket__pf), false, 0));
	bpv__MagazineAmmo__pf = 1;
	bpv__AmmoType__pf = E__E_LoadType__pf::NewEnumerator0;
	...
	bpv__InGun__pf = false;
	bpv__AmmoxObjectxType__pfTT = E__ENUM_ObjectType__pf::NewEnumerator4;
	bpv__AmmoWidget_Ref__pf = nullptr;
...
void ABP_AmmoBase_C__pf1418999182::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__AmmoWidget_SpawnLoc__pf)
	{
		bpv__AmmoWidget_SpawnLoc__pf->CreationMethod = EComponentCreationMethod::Native;
	}
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_AmmoBase_C__pf1418999182::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(AAmmoDisplay_C__pf3627927311::StaticClass());
	...
	__Local__27->ComponentDelegateBindings.AddUninitialized(2);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__27->ComponentDelegateBindings.GetData(), 2);
	auto& __Local__30 = __Local__27->ComponentDelegateBindings[0];
	__Local__30.ComponentPropertyName = FName(TEXT("MagnetCollision"));
	__Local__30.DelegatePropertyName = FName(TEXT("OnComponentEndOverlap"));
	__Local__30.FunctionNameToBind = FName(TEXT("BndEvt__BP_AmmoBase_MagnetCollision_K2Node_ComponentBoundEvent_3_ComponentEndOverlapSignature__DelegateSignature"));
	auto& __Local__31 = __Local__27->ComponentDelegateBindings[1];
	__Local__31.ComponentPropertyName = FName(TEXT("MagnetCollision"));
	__Local__31.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__31.FunctionNameToBind = FName(TEXT("BndEvt__BP_AmmoBase_MagnetCollision_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_AmmoBase_C__pf1418999182::bpf__ExecuteUbergraph_BP_AmmoBase__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 40:
			{
				if(::IsValid(bpv__AmmoWidget_Ref__pf))
				{
					bpv__AmmoWidget_Ref__pf->bpf__IsBeingHeld__pf(false);
				}
			}
		case 41:
			{
		...
		case 42:
			{
				bpfv__CallFunc_Array_Length_ReturnValue_2__pf = FCustomThunkTemplates::Array_Length(bpv__OverlappingMagnets__pf);
		...
		case 43:
			{
				FCustomThunkTemplates::Array_Get(bpv__OverlappingMagnets__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item_2__pf);
				IBPI_Magnetic_C::Execute_bpf__Magnetize__pf(this , b0l__CallFunc_Array_Get_Item_2__pf);
				__CurrentState = -1;
				break;
			}
		default:
...
void ABP_AmmoBase_C__pf1418999182::bpf__ExecuteUbergraph_BP_AmmoBase__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 30);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__GrabbableObjectSocket__pf))
	{
		bpv__GrabbableObjectSocket__pf->bpf__Grab__pf(bpv__Ammo_SM__pf, this, b0l__K2Node_Event_HandSocket__pf, b0l__K2Node_Event_AttachToMe__pf);
	}
	bpv__IsGrabbed__pf = true;
	if(::IsValid(bpv__AmmoWidget_Ref__pf))
	{
		bpv__AmmoWidget_Ref__pf->bpf__IsBeingHeld__pf(true);
	}
...
void ABP_AmmoBase_C__pf1418999182::bpf__ExecuteUbergraph_BP_AmmoBase__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	AAmmoDisplay_C__pf3627927311* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	...
	bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, AAmmoDisplay_C__pf3627927311::StaticClass(), bpfv__CallFunc_MakeTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AdjustIfPossibleButAlwaysSpawn, this);
	bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(FVector(0.000000,0.000000,0.000000), FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000));
	bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<AAmmoDisplay_C__pf3627927311>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_MakeTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
	bpv__AmmoWidget_Ref__pf = bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf;
	if(::IsValid(bpv__AmmoWidget_Ref__pf))
	{
		bpv__AmmoWidget_Ref__pf->AActor::K2_AttachToComponent(bpv__AmmoWidget_SpawnLoc__pf, FName(TEXT("None")), EAttachmentRule::KeepRelative, EAttachmentRule::KeepRelative, EAttachmentRule::KeepRelative, false);
	}
	bpf__OnAmmoChange__pf(bpv__MagazineAmmo__pf);
	return; //KCST_EndOfThread
}
void ABP_AmmoBase_C__pf1418999182::bpf__ExecuteUbergraph_BP_AmmoBase__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 63);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__AmmoWidget_Ref__pf))
	{
		bpv__AmmoWidget_Ref__pf->bpf__Update_Ammo__pf(b0l__K2Node_CustomEvent_RemainingShots__pf);
	}
	return; //KCST_EndOfThread
}
void ABP_AmmoBase_C__pf1418999182::bpf__ExecuteUbergraph_BP_AmmoBase__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 16:
			{
				FCustomThunkTemplates::Array_Get(bpv__OverlappingMagnets__pf, b0l__Temp_int_Array_Index_Variable_1__pf, /*out*/ b0l__CallFunc_Array_Get_Item_1__pf);
				bool  __Local__32 = false;
				if (!((::IsValid(b0l__CallFunc_Array_Get_Item_1__pf)) ? (b0l__CallFunc_Array_Get_Item_1__pf->bpv__Occupied__pf) : (__Local__32)))
				{
					__CurrentState = 23;
					break;
				}
		...
		case 18:
			{
				if(::IsValid(bpv__Ammo_SM__pf))
				{
					bpv__Ammo_SM__pf->SetSimulatePhysics(false);
				}
			}
		case 19:
			{
				...
				if(::IsValid(bpv__Ammo_SM__pf))
				{
					bpfv__CallFunc_K2_AttachToComponent_ReturnValue__pf = bpv__Ammo_SM__pf->USceneComponent::K2_AttachToComponent(bpfv__CallFunc_K2_GetRootComponent_ReturnValue_2__pf, FName(TEXT("None")), EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, EAttachmentRule::KeepWorld, false);
				}
			}
		case 20:
			{
		...
		case 23:
			{
				FCustomThunkTemplates::Array_Get(bpv__OverlappingMagnets__pf, b0l__Temp_int_Array_Index_Variable_1__pf, /*out*/ b0l__CallFunc_Array_Get_Item_1__pf);
				E__ENUM_ObjectType__pf  __Local__33 = E__ENUM_ObjectType__pf::NewEnumerator0;
				bpfv__CallFunc_EqualEqual_ByteByte_ReturnValue_1__pf = UKismetMathLibrary::EqualEqual_ByteByte(static_cast<uint8>(((::IsValid(b0l__CallFunc_Array_Get_Item_1__pf)) ? (b0l__CallFunc_Array_Get_Item_1__pf->bpv__ObjectxType__pfT) : (__Local__33))), static_cast<uint8>(E__ENUM_ObjectType__pf::NewEnumerator0));
				E__ENUM_ObjectType__pf  __Local__34 = E__ENUM_ObjectType__pf::NewEnumerator0;
				bpfv__CallFunc_EqualEqual_ByteByte_ReturnValue_2__pf = UKismetMathLibrary::EqualEqual_ByteByte(static_cast<uint8>(bpv__AmmoxObjectxType__pfTT), static_cast<uint8>(((::IsValid(b0l__CallFunc_Array_Get_Item_1__pf)) ? (b0l__CallFunc_Array_Get_Item_1__pf->bpv__ObjectxType__pfT) : (__Local__34))));
				bpfv__CallFunc_BooleanOR_ReturnValue__pf = UKismetMathLibrary::BooleanOR(bpfv__CallFunc_EqualEqual_ByteByte_ReturnValue_2__pf, bpfv__CallFunc_EqualEqual_ByteByte_ReturnValue_1__pf);
		...
		case 25:
			{
				...
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__MagnetCollision__pf->USceneComponent::K2_GetComponentLocation();
				}
				...
				bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf = UKismetMathLibrary::Subtract_VectorVector(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf);
				FCustomThunkTemplates::Array_Get(bpv__OverlappingMagnets__pf, b0l__Temp_int_Array_Index_Variable_1__pf, /*out*/ b0l__CallFunc_Array_Get_Item_1__pf);
				...
				{
					bpfv__CallFunc_K2_GetRootComponent_ReturnValue_1__pf = b0l__CallFunc_Array_Get_Item_1__pf->AActor::K2_GetRootComponent();
				}
				...
				bpfv__CallFunc_Subtract_VectorVector_ReturnValue_1__pf = UKismetMathLibrary::Subtract_VectorVector(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_2__pf);
		...
		case 26:
			{
				FCustomThunkTemplates::Array_Get(bpv__OverlappingMagnets__pf, b0l__Temp_int_Array_Index_Variable_1__pf, /*out*/ b0l__CallFunc_Array_Get_Item_1__pf);
				bpv__ClosestMount__pf = b0l__CallFunc_Array_Get_Item_1__pf;
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 27:
...
void ABP_AmmoBase_C__pf1418999182::bpf__ExecuteUbergraph_BP_AmmoBase__pf_5(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				if(::IsValid(bpv__Ammo_SM__pf))
				{
					...
					bpv__Ammo_SM__pf->UPrimitiveComponent::GetOverlappingActors(/*out*/ b0l__CallFunc_GetOverlappingActors_OverlappingActors__pf, ABP_Firearm_Base_C__pf1418999182::StaticClass());
				}
		...
		case 5:
			{
				...
				b0l__K2Node_DynamicCast_AsBP_Firearm_Base__pf = Cast<ABP_Firearm_Base_C__pf1418999182>(b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsBP_Firearm_Base__pf != nullptr);;
		...
		case 6:
			{
				E__E_LoadType__pf  __Local__35 = E__E_LoadType__pf::NewEnumerator0;
				bpfv__CallFunc_EqualEqual_ByteByte_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ByteByte(static_cast<uint8>(((::IsValid(b0l__K2Node_DynamicCast_AsBP_Firearm_Base__pf)) ? (b0l__K2Node_DynamicCast_AsBP_Firearm_Base__pf->bpv__loadType__pf) : (__Local__35))), static_cast<uint8>(bpv__AmmoType__pf));
		...
		case 7:
			{
				if(::IsValid(bpv__Ammo_SM__pf))
				{
					bpfv__CallFunc_GetOwner_ReturnValue__pf = bpv__Ammo_SM__pf->UActorComponent::GetOwner();
				}
				if(::IsValid(bpfv__CallFunc_GetOwner_ReturnValue__pf))
				{
					bpfv__CallFunc_GetOwner_ReturnValue__pf->AActor::K2_AttachToActor(b0l__K2Node_DynamicCast_AsBP_Firearm_Base__pf, FName(TEXT("Magazine_Port")), EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, true);
				}
			}
		case 8:
			{
		...
		case 9:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsBP_Firearm_Base__pf))
				{
					b0l__K2Node_DynamicCast_AsBP_Firearm_Base__pf->bpf__Reload__pf(this, bpv__MagazineAmmo__pf);
				}
			}
		case 10:
			{
...
void ABP_AmmoBase_C__pf1418999182::bpf__ExecuteUbergraph_BP_AmmoBase__pf_6(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsBP_Magnetic_Placement_1__pf != nullptr);;
...
void ABP_AmmoBase_C__pf1418999182::bpf__ExecuteUbergraph_BP_AmmoBase__pf_7(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsBP_Magnetic_Placement__pf != nullptr);;
...
void ABP_AmmoBase_C__pf1418999182::bpf__OnAmmoChange__pf(int32 bpp__RemainingShots__pf)
{
	b0l__K2Node_CustomEvent_RemainingShots__pf = bpp__RemainingShots__pf;
	bpf__ExecuteUbergraph_BP_AmmoBase__pf_3(63);
}
void ABP_AmmoBase_C__pf1418999182::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BP_AmmoBase__pf_2(57);
}
void ABP_AmmoBase_C__pf1418999182::bpf__BndEvt__BP_AmmoBase_MagnetCollision_K2Node_ComponentBoundEvent_3_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
	...
	bpf__ExecuteUbergraph_BP_AmmoBase__pf_6(54);
}
void ABP_AmmoBase_C__pf1418999182::bpf__BndEvt__BP_AmmoBase_MagnetCollision_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	typedef FHitResult  T__Local__36;
	T__Local__36& bpp__SweepResult__pf = *const_cast<T__Local__36 *>(&bpp__SweepResult__pf__const);
	...
	bpf__ExecuteUbergraph_BP_AmmoBase__pf_7(51);
}
void ABP_AmmoBase_C__pf1418999182::bpf__Magnetize__pf(AActor* bpp__Magnet__pf)
{
	b0l__K2Node_Event_Magnet__pf = bpp__Magnet__pf;
	bpf__ExecuteUbergraph_BP_AmmoBase__pf_4(47);
}
void ABP_AmmoBase_C__pf1418999182::bpf__SnapEvent__pf()
{
	bpf__ExecuteUbergraph_BP_AmmoBase__pf_5(44);
}
void ABP_AmmoBase_C__pf1418999182::bpf__Release__pf(EControllerHand bpp__NewParam__pf)
{
	b0l__K2Node_Event_NewParam__pf = bpp__NewParam__pf;
	bpf__ExecuteUbergraph_BP_AmmoBase__pf_0(37);
}
void ABP_AmmoBase_C__pf1418999182::bpf__Grab__pf(FName bpp__HandSocket__pf, USceneComponent* bpp__AttachToMe__pf, AActor* bpp__Actor__pf)
{
	...
	bpf__ExecuteUbergraph_BP_AmmoBase__pf_1(30);
}
void ABP_AmmoBase_C__pf1418999182::bpf__UserConstructionScript__pf()
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoType__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator0));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 2;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoType__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator2));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 3;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoType__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator3));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 4;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoType__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator4));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 3;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__AmmoType__pf), static_cast<uint8>(E__E_LoadType__pf::NewEnumerator1));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 5;
					break;
		...
		case 2:
			{
				bpv__MagazineAmmo__pf = 12;
				__CurrentState = -1;
				break;
			}
		case 3:
			{
				bpv__MagazineAmmo__pf = 30;
				__CurrentState = -1;
				break;
			}
		case 4:
			{
				bpv__MagazineAmmo__pf = 20;
				__CurrentState = -1;
				break;
			}
		case 5:
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_AmmoBase_C__pf1418999182::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_AmmoBase_C__pf1418999182::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{168, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/HUD/Widgets/Ammo_Display/AmmoDisplay.AmmoDisplay_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_AmmoBase_C__pf1418999182
{
	FRegisterHelper__ABP_AmmoBase_C__pf1418999182()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Weapons/BP_AmmoBase"), &ABP_AmmoBase_C__pf1418999182::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_AmmoBase_C__pf1418999182 Instance;
};
FRegisterHelper__ABP_AmmoBase_C__pf1418999182 FRegisterHelper__ABP_AmmoBase_C__pf1418999182::Instance;
