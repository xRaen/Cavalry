...
ADamageIndicator_Actor_C__pf760233656::ADamageIndicator_Actor_C__pf760233656(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__Widget_Root__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Widget_Root"));
	bpv__Cur_DamageIndicator__pf = CreateDefaultSubobject<UWidgetComponent>(TEXT("Cur_DamageIndicator"));
	...
	bpv__Widget_Root__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Widget_Root__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Widget_Root__pf), true, 0));
	bpv__Cur_DamageIndicator__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Cur_DamageIndicator__pf->AttachToComponent(bpv__Widget_Root__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<TSubclassOf<UUserWidget>  >((bpv__Cur_DamageIndicator__pf), UWidgetComponent::__PPO__WidgetClass() )));
	__Local__2 = USpawned_DI_C__pf760233656::StaticClass();
	auto& __Local__3 = (*(AccessPrivateProperty<FIntPoint >((bpv__Cur_DamageIndicator__pf), UWidgetComponent::__PPO__DrawSize() )));
	__Local__3.X = 1920;
	__Local__3.Y = 1080;
	auto& __Local__4 = (*(AccessPrivateProperty<FLinearColor >((bpv__Cur_DamageIndicator__pf), UWidgetComponent::__PPO__TintColorAndOpacity() )));
	__Local__4 = FLinearColor(0.300000, 0.300000, 0.300000, 0.600000);
	auto& __Local__5 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Cur_DamageIndicator__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__15.Channel = FName(TEXT("Enemy"));
	__Local__15.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__16 = __Local__6[9];
	__Local__16.Channel = FName(TEXT("PlayerCollision"));
	...
	bpv__Cur_DamageIndicator__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__18 = (*(AccessPrivateProperty<FVector >((bpv__Cur_DamageIndicator__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__18 = FVector(200.000000, 0.000048, -65.000000);
	auto& __Local__19 = (*(AccessPrivateProperty<FRotator >((bpv__Cur_DamageIndicator__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__19 = FRotator(0.000000, 180.000000, 0.000000);
	auto& __Local__20 = (*(AccessPrivateProperty<FVector >((bpv__Cur_DamageIndicator__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__20 = FVector(0.500000, 0.500000, 0.500000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Cur_DamageIndicator__pf), true, 0));
	bpv__Cur_Direction__pf = FVector(0.000000, 0.000000, 0.000000);
...
void ADamageIndicator_Actor_C__pf760233656::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__Widget_Root__pf)
	{
		bpv__Widget_Root__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Cur_DamageIndicator__pf)
	{
		bpv__Cur_DamageIndicator__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ADamageIndicator_Actor_C__pf760233656::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(USpawned_DI_C__pf760233656::StaticClass());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
}
PRAGMA_ENABLE_OPTIMIZATION
void ADamageIndicator_Actor_C__pf760233656::bpf__ExecuteUbergraph_DamageIndicator_Actor__pf_0(int32 bpp__EntryPoint__pf)
{
	UUserWidget* bpfv__CallFunc_GetWidget_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 5);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__Cur_DamageIndicator__pf))
	{
		bpfv__CallFunc_GetWidget_ReturnValue__pf = bpv__Cur_DamageIndicator__pf->GetWidget();
	}
	b0l__K2Node_DynamicCast_AsSpawned_DI__pf = Cast<USpawned_DI_C__pf760233656>(bpfv__CallFunc_GetWidget_ReturnValue__pf);
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsSpawned_DI__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsSpawned_DI__pf))
	{
		b0l__K2Node_DynamicCast_AsSpawned_DI__pf->bpv__DamageDirection__pf = bpv__Cur_Direction__pf;
	}
	// optimized KCST_UnconditionalGoto
	if (!bpv__Destroyx__pfzy)
	{
		return; //KCST_EndOfThreadIfNot
	}
	// optimized KCST_UnconditionalGoto
...
void ADamageIndicator_Actor_C__pf760233656::bpf__ExecuteUbergraph_DamageIndicator_Actor__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 9:
			{
				UKismetSystemLibrary::Delay(this, 1.000000, FLatentActionInfo(1, -1877807260, TEXT("ExecuteUbergraph_DamageIndicator_Actor_1"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void ADamageIndicator_Actor_C__pf760233656::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_DamageIndicator_Actor__pf_1(8);
}
void ADamageIndicator_Actor_C__pf760233656::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_DamageIndicator_Actor__pf_0(5);
}
PRAGMA_DISABLE_OPTIMIZATION
void ADamageIndicator_Actor_C__pf760233656::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ADamageIndicator_Actor_C__pf760233656::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{159, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/Widgets/Damage_Display/Spawned_DI.Spawned_DI_C 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ADamageIndicator_Actor_C__pf760233656
{
	FRegisterHelper__ADamageIndicator_Actor_C__pf760233656()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/Widgets/Damage_Display/DamageIndicator_Actor"), &ADamageIndicator_Actor_C__pf760233656::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ADamageIndicator_Actor_C__pf760233656 Instance;
};
FRegisterHelper__ADamageIndicator_Actor_C__pf760233656 FRegisterHelper__ADamageIndicator_Actor_C__pf760233656::Instance;
