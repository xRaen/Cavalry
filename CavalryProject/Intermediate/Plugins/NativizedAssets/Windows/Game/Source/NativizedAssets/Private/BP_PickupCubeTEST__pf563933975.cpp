...
#include "BP_PickupCubeTEST__pf563933975.h"
#include "GeneratedCodeHelpers.h"
#include "Runtime/Engine/Classes/Engine/SimpleConstructionScript.h"
#include "Runtime/Engine/Classes/Engine/SCS_Node.h"
#include "GrabbableObject__pf2132744816.h"
...
ABP_PickupCubeTEST_C__pf563933975::ABP_PickupCubeTEST_C__pf563933975(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_PickupCubeTEST_C__pf563933975::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
		...
		__Local__5.AddUninitialized(1);
		FResponseChannel::StaticStruct()->InitializeStruct(__Local__5.GetData(), 1);
		auto& __Local__6 = __Local__5[0];
		__Local__6.Channel = FName(TEXT("PlayerHands"));
		auto& __Local__7 = (*(AccessPrivateProperty<float >(&(__Local__0->BodyInstance), FBodyInstance::__PPO__MassInKgOverride() )));
		__Local__7 = 442.797729f;
		...
		auto& __Local__8 = (*(AccessPrivateProperty<FVector >((__Local__0), USceneComponent::__PPO__RelativeScale3D() )));
		...
		(((FBoolProperty*)__Local__9)->SetPropertyValue_InContainer((__Local__0), true, 0));
		// --- END default subobject 'StaticMeshComponent0' //
	}
	bpv__GrabbableObject__pf = CreateDefaultSubobject<UGrabbableObject_C__pf2132744816>(TEXT("GrabbableObject"));
	bpv__GrabbableObject__pf->CreationMethod = EComponentCreationMethod::Native;
	...
	(((FBoolProperty*)__Local__11)->SetPropertyValue_InContainer((bpv__GrabbableObject__pf), false, 0));
	auto& __Local__13 = (*(AccessPrivateProperty<UStaticMeshComponent*>((this), AStaticMeshActor::__PPO__StaticMeshComponent() )));
	...
	{
		__Local__14 = (AActor::StaticClass())->FindPropertyByName(FName(TEXT("bCanBeDamaged")));
		check(__Local__14);
		__Local__15 = __Local__14;
	}
	(((FBoolProperty*)__Local__14)->SetPropertyValue_InContainer((this), true, 0));
...
void ABP_PickupCubeTEST_C__pf563933975::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__GrabbableObject__pf)
	{
		bpv__GrabbableObject__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_PickupCubeTEST_C__pf563933975::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UGrabbableObject_C__pf2132744816::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_PickupCubeTEST_C__pf563933975::bpf__ExecuteUbergraph_BP_PickupCubeTEST__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 5);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__GrabbableObject__pf))
	{
		bpv__GrabbableObject__pf->bpf__Grab__pf((*(AccessPrivateProperty<UStaticMeshComponent* >((this), AStaticMeshActor::__PPO__StaticMeshComponent() ))), this, b0l__K2Node_Event_AttachToMe__pf, true);
	}
	return; // KCST_GotoReturn
}
void ABP_PickupCubeTEST_C__pf563933975::bpf__ExecuteUbergraph_BP_PickupCubeTEST__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__GrabbableObject__pf))
	{
		bpv__GrabbableObject__pf->bpf__Release__pf(true);
	}
	return; // KCST_GotoReturn
}
void ABP_PickupCubeTEST_C__pf563933975::bpf__ExecuteUbergraph_BP_PickupCubeTEST__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 4);
	return; // KCST_GotoReturn
}
void ABP_PickupCubeTEST_C__pf563933975::bpf__ExecuteUbergraph_BP_PickupCubeTEST__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 3);
	return; // KCST_GotoReturn
}
void ABP_PickupCubeTEST_C__pf563933975::bpf__Release__pf(EControllerHand bpp__NewParam__pf)
{
	b0l__K2Node_Event_NewParam__pf = bpp__NewParam__pf;
	bpf__ExecuteUbergraph_BP_PickupCubeTEST__pf_1(1);
}
void ABP_PickupCubeTEST_C__pf563933975::bpf__Grab__pf(FName bpp__HandSocket__pf, USceneComponent* bpp__AttachToMe__pf, AActor* bpp__Actor__pf)
{
	...
	bpf__ExecuteUbergraph_BP_PickupCubeTEST__pf_0(5);
}
void ABP_PickupCubeTEST_C__pf563933975::bpf__Drop__pf()
{
	bpf__ExecuteUbergraph_BP_PickupCubeTEST__pf_2(4);
}
void ABP_PickupCubeTEST_C__pf563933975::bpf__Pickup__pf(USceneComponent* bpp__AttachTo__pf)
{
	b0l__K2Node_Event_AttachTo__pf = bpp__AttachTo__pf;
	bpf__ExecuteUbergraph_BP_PickupCubeTEST__pf_3(3);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_PickupCubeTEST_C__pf563933975::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{252, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  MaterialInstanceConstant /Game/VirtualReality/Materials/MI_SmallCubes.MI_SmallCubes 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_PickupCubeTEST_C__pf563933975::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{253, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.StaticMeshActor 
		...
		{254, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/GrabbableObject.GrabbableObject_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_PickupCubeTEST_C__pf563933975
{
	FRegisterHelper__ABP_PickupCubeTEST_C__pf563933975()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/VirtualRealityBP/Blueprints/BP_PickupCubeTEST"), &ABP_PickupCubeTEST_C__pf563933975::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_PickupCubeTEST_C__pf563933975 Instance;
};
FRegisterHelper__ABP_PickupCubeTEST_C__pf563933975 FRegisterHelper__ABP_PickupCubeTEST_C__pf563933975::Instance;
